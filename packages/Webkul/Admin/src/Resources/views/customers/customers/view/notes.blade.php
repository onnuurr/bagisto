        ...
        <div class="border-b p-4 dark:border-gray-800">
            ...
            <div class="flex items-center justify-between">
                ...
                >
                    ...
                    <span class="icon-uncheckbox peer-checked:icon-checked cursor-pointer rounded-md text-2xl peer-checked:text-primary"></span>
        ...
        <div class="grid gap-1.5 border-b p-4 last:border-none dark:border-gray-800">
            ...
            <p class="flex items-center gap-2 text-gray-600 dark:text-gray-300">
                @if ($note->customer_notified)
                    <span class="icon-done h-fit rounded-full bg-primary-100 text-2xl text-primary dark:!text-primary"></span>
