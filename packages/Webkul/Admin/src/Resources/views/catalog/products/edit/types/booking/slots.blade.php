            ...
            <template v-else>
                ...
                >
                    ...
                    <div class="flex items-center justify-between grid-cols-2">
                        ...
                        <p
                            class="text-right text-primary transition-all cursor-pointer place-content-start hover:underline"
                    ...
                    <x-slot:header>
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-4 ltr:mr-11 rtl:ml-11">
                                <!-- Add Slots Button -->
                                <div
                                    class="font-medium text-primary cursor-pointer w-fit dark:text-white"
                                    @click="add"
                                >
                                    @lang('admin::app.catalog.products.edit.types.booking.slots.add')
                                </div>
