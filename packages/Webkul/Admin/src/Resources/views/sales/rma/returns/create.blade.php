                        ...
                        <x-admin::modal ref="rmaModel" panel-class="max-w-[768px]">
                            ...
                            <x-slot:footer>
                                <div class="flex justify-end">
                                    ...
                                    >
                                        <svg v-if="!rmaFormSubmit" aria-hidden="true" class="w-5 h-5 text-gray-200 animate-spin fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p class="flex text-sm justify-between">
                                    <template v-if="product.url_key && product.visible_individually">
                                        <a
                                            ...
                                            target='_blank'
                                            class="text-base font-semibold text-primary hover:underline dark:text-primary-400"
                                        >
                                            @{{ product.name }}
