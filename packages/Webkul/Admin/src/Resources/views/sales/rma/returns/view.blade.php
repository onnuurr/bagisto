                                    ...
                                    >
                                        ...
                                        <div class="flex justify-end">
                                            <button
                                                ...
                                                disabled
                                            >
                                                <svg  aria-hidden="true" class="w-4 h-4 text-gray-200 animate-spin fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div v-if="message.is_admin == 1" class="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white font-bold">
                                                ...
                                                <div
                                                    :class="[
                                                        ...
                                                        message.is_admin == 1 ? 'bg-primary-50 dark:bg-primary-900/40' : 'bg-white dark:bg-gray-800'
                                                    ]"
            ...
            app.component('v-admin-rma-view', {
                ...
                methods: {
                    ...
                    handleFileSelect($event) {
                        ...
                        removeButton.classList.add('text-primary');
