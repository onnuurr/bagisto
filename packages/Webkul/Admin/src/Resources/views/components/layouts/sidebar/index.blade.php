<div class="fixed top-14 z-[1000] h-full w-[270px] border-r border-gray-200 bg-gray-50 pt-4 transition-all duration-300 group-[.sidebar-collapsed]/container:w-[70px] dark:border-gray-800 dark:bg-gray-900 max-lg:hidden">
                ...
                >
                    ...
                    >
                        ...
                        @if ($menuItem->haveChildren())
                            <span
                                class="icon-sort-down sidebar-submenu-arrow ltr:ml-auto rtl:mr-auto text-lg transition-transform duration-200 group-[.sidebar-collapsed]/container:hidden {{ $menuItem->isActive() ? 'rotate-180 text-primary' : 'text-gray-400' }}"
                            ></span>
                        @endif
                    </a>

                    @if ($menuItem->haveChildren())
                        <div class="sidebar-submenu {{ $menuItem->isActive() ? '' : 'hidden' }} grid min-w-[180px] gap-1 ltr:pl-10 rtl:pr-10 pb-2 rounded-b-lg z-[100] overflow-hidden group-[.sidebar-collapsed]/container:!hidden group-[.sidebar-collapsed]/container:fixed group-[.sidebar-collapsed]/container:ltr:!left-[70px] group-[.sidebar-collapsed]/container:rtl:!right-[70px] group-[.sidebar-collapsed]/container:p-[0] group-[.sidebar-collapsed]/container:bg-white dark:group-[.sidebar-collapsed]/container:bg-gray-900 group-[.sidebar-collapsed]/container:border group-[.sidebar-collapsed]/container:ltr:rounded-r-lg group-[.sidebar-collapsed]/container:rtl:rounded-l-lg group-[.sidebar-collapsed]/container:border-gray-300 group-[.sidebar-collapsed]/container:dark:border-gray-800 group-[.sidebar-collapsed]/container:rounded-none group-[.sidebar-collapsed]/container:ltr:shadow-[34px_10px_14px_rgba(0,0,0,0.01),19px_6px_12px_rgba(0,0,0,0.03),9px_3px_9px_rgba(0,0,0,0.04),2px_1px_5px_rgba(0,0,0,0.05),0px_0px_0px_rgba(0,0,0,0.05)] group-[.sidebar-collapsed]/container:rtl:shadow-[-34px_10px_14px_rgba(0,0,0,0.01),-19px_6px_12px_rgba(0,0,0,0.03),-9px_3px_9px_rgba(0,0,0,0.04),-2px_1px_5px_rgba(0,0,0,0.05),-0px_0px_0px_rgba(0,0,0,0.05)] group-[.sidebar-collapsed]/container:group-hover/item:!grid">
                            @foreach ($menuItem->getChildren() as $subMenuItem)
                                <a
                                    href="{{ $subMenuItem->getUrl() }}"
                                    class="text-sm {{ $subMenuItem->isActive() ? 'text-primary dark:text-primary-400' : 'text-gray-600 dark:text-gray-300' }} whitespace-nowrap py-1 group-[.sidebar-collapsed]/container:px-5 group-[.sidebar-collapsed]/container:py-2.5 hover:text-primary dark:hover:bg-gray-950"
                                >
                                    {{ $subMenuItem->getName() }}
                                </a>
                            @endforeach
        ...
        const initSidebarAccordion = () => {
            document.querySelectorAll('[data-sidebar-toggle]').forEach((toggle) => {
                toggle.addEventListener('click', function (e) {
                    ...
                    this.querySelector('.sidebar-submenu-arrow')?.classList.toggle('rotate-180', ! isOpen);
                });
            });
        };
