    ...
    'catalog' => [
        ...
        'product-tags' => [
            'index' => [
                ...
                'datagrid' => [
                    'delete' => 'מחק',
                    'delete-failed' => 'אירעה שגיאה במחיקת תג המוצר',
                    'delete-success' => 'תג המוצר נמחק בהצלחה.',
                    'edit' => 'ערוך',
                    'id' => 'מזהה',
                    'image' => 'תמונה',
                    'mass-delete-success' => 'תגי המוצר שנבחרו נמחקו בהצלחה',
                    'name' => 'שם',
                ],
            ],
            ...
            'create' => [
                'back-btn' => 'חזור',
                'create-success' => 'תג המוצר נוצר בהצלחה.',
                'general' => 'כללי',
                'image' => 'תמונה',
                'image-info' => 'התמונה תוצג על המוצר אם היא זמינה, אחרת יוצג השם כתג טקסט.',
                'name' => 'שם',
                'save-btn' => 'שמור תג מוצר',
                'title' => 'הוסף תג מוצר חדש',
            ],
            ...
            'edit' => [
                ...
                'save-btn' => 'שמור תג מוצר',
                'title' => 'ערוך תג מוצר',
                'update-success' => 'תג המוצר עודכן בהצלחה.',
            ],
        ],
