...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'החשבון נוצר בהצלחה.',
            'update-success' => 'החשבון עודכן בהצלחה.',
            'delete-success' => 'החשבון נמחק בהצלחה.',
            'system-account-error' => 'זהו חשבון מערכת מוגן ולא ניתן למחוק אותו.',
            'in-use-error' => 'לחשבון זה יש חשבונות בת או פקודות יומן ולא ניתן למחוק אותו.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'פקודות יומן',
                'create-btn' => 'צור פקודת יומן',
                'datagrid' => [
                    'id' => 'מזהה',
                    'entry-number' => 'מספר פקודה',
                    'entry-date' => 'תאריך הפקודה',
                    'reference-type' => 'אסמכתא',
                    'description' => 'תיאור',
                    'total' => 'סה"כ',
                    'status' => 'סטטוס',
                    'view' => 'צפה',
            ...
            'create' => [
                'title' => 'צור פקודת יומן',
                'back-btn' => 'חזרה',
                'save-draft-btn' => 'שמור כטיוטה',
                'save-post-btn' => 'שמור ורשום',
                'general' => 'כללי',
                'entry-date' => 'תאריך הפקודה',
                'description' => 'תיאור',
                'lines' => 'שורות',
                'account' => 'חשבון',
                'line-description' => 'תיאור',
                'debit' => 'חובה',
                'credit' => 'זכות',
            ...
            'auto-post' => [
                'invoice' => 'נרשם אוטומטית עבור חשבונית :invoice',
                'payment' => 'תשלום נרשם אוטומטית עבור חשבונית :invoice',
                'refund' => 'נרשם אוטומטית עבור החזר #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'פקודת היומן אינה מאוזנת. סך החובה חייב להיות שווה לסך הזכות.',
                'only-draft-can-be-posted' => 'ניתן לרשום רק פקודות יומן שהן בטיוטה.',
                'only-posted-can-be-voided' => 'ניתן לבטל רק פקודות יומן שנרשמו.',
            ],
            'create-success' => 'פקודת היומן נוצרה בהצלחה.',
            'post-success' => 'פקודת היומן נרשמה בהצלחה.',
            'void-success' => 'פקודת היומן בוטלה בהצלחה.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'ספר חשבונות',
                ...
                'credit' => 'זכות',
                'balance' => 'יתרה',
                'no-transactions' => 'לא נמצאו תנועות עבור התקופה שנבחרה.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'שנות כספים',
                'create-btn' => 'צור שנת כספים',
                'datagrid' => [
                    'id' => 'מזהה',
                    'code' => 'קוד',
                    'start-date' => 'תאריך התחלה',
            ...
            'create' => [
                'title' => 'צור שנת כספים',
                'back-btn' => 'חזרה',
                'save-btn' => 'שמור שנת כספים',
                'code' => 'קוד',
                'code-placeholder' => 'לדוגמה FY2026',
                'start-date' => 'תאריך התחלה',
                'end-date' => 'תאריך סיום',
            ],
            'statuses' => [
            ...
            'create-success' => 'שנת הכספים נוצרה בהצלחה.',
            'close-success' => 'שנת הכספים נסגרה בהצלחה.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'הגדרות הנהלת חשבונות',
                'save-btn' => 'שמור הגדרות',
                'mapping-title' => 'שיוך חשבונות ברירת מחדל',
                'mapping-info' => 'שייכו את החשבונות המשמשים לרישום אוטומטי של פקודות יומן בעת יצירת חשבוניות, תשלומים והחזרים.',
                'accounts-receivable-account' => 'חשבון לקוחות',
                'cash-bank-account' => 'חשבון קופה / בנק',
                'sales-revenue-account' => 'חשבון הכנסות ממכירה',
                'shipping-revenue-account' => 'חשבון הכנסות משילוח',
                'sales-discount-account' => 'חשבון הנחות מכירה',
                'sales-refund-account' => 'חשבון החזרי מכירה',
                'tax-payable-account' => 'חשבון מס לתשלום',
                'not-mapped' => 'לא משויך',
            ],
            'update-success' => 'הגדרות הנהלת החשבונות עודכנו בהצלחה.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'מאזן בוחן',
            ...
            'balance-sheet' => [
                ...
                'equity' => 'הון עצמי',
                'total-assets' => 'סה"כ נכסים',
                'total-liabilities' => 'סה"כ התחייבויות',
                'total-equity' => 'סה"כ הון עצמי',
                'current-earnings' => 'רווח התקופה הנוכחית',
                'total-liabilities-and-equity' => 'סה"כ התחייבויות והון עצמי',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'instructions' => 'הוראות',
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'הגדירו את הגדרות שער התשלום iyzico. לאחר השמירה, הגדירו את כתובת ה-Callback בהגדרות האינטגרציה בלוח הבקרה של iyzico שלכם ל-your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'הזינו את המפתח הסודי שקיבלתם מלוח הבקרה של iyzico',
                    'local-payment' => 'תשלום מקומי',
                    'local-payment-info' => 'שיטת תשלום ידנית מקומית שניתן להתאים אישית לפי הצורך.',
                    'logo' => 'לוגו',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'הגדירו את הגדרות שער התשלום PayTR. לאחר השמירה, הגדירו את כתובת ה-URL להתראות בפאנל הסוחר של PayTR שלכם ל-your-shop-url/paytr/notify — PayTR דורש שהגדרה זו תתבצע באופן ידני.',
                    'paytr-merchant-id-info' => 'הזינו את מזהה הסוחר שקיבלתם מפאנל PayTR',
                    'paytr-merchant-key-info' => 'הזינו את מפתח הסוחר שקיבלתם מפאנל PayTR',
                    'paytr-merchant-salt-info' => 'הזינו את מלח הסוחר שקיבלתם מפאנל PayTR',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'הגדרות',
                'chart-of-accounts' => 'תרשים חשבונות',
                'fiscal-years' => 'שנות כספים',
    ...
    'acl' => [
        ...
        'accounting-close' => 'סגור',
        'accounting-fiscal-years' => 'שנות כספים',
        'accounting-journal-entries' => 'פקודות יומן',
        'accounting-ledger' => 'ספר חשבונות',
        'accounting-post' => 'רשום',
        'accounting-reports' => 'דוחות',
        'accounting-settings' => 'הגדרות',
        'accounting-void' => 'בטל',
        'addresses' => 'כתובות',
        'attribute-families' => 'משפחות מאפיינים',
