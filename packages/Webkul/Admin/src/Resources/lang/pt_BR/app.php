...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'Conta criada com sucesso.',
            'update-success' => 'Conta atualizada com sucesso.',
            'delete-success' => 'Conta excluída com sucesso.',
            'system-account-error' => 'Esta é uma conta de sistema protegida e não pode ser excluída.',
            'in-use-error' => 'Esta conta possui subcontas ou lançamentos contábeis e não pode ser excluída.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Lançamentos contábeis',
                'create-btn' => 'Criar lançamento contábil',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Número do lançamento',
                    'entry-date' => 'Data do lançamento',
                    'reference-type' => 'Referência',
                    'description' => 'Descrição',
                    'total' => 'Total',
                    'status' => 'Status',
                    'view' => 'Visualizar',
            ...
            'create' => [
                'title' => 'Criar lançamento contábil',
                'back-btn' => 'Voltar',
                'save-draft-btn' => 'Salvar como rascunho',
                'save-post-btn' => 'Salvar e registrar',
                'general' => 'Geral',
                'entry-date' => 'Data do lançamento',
                'description' => 'Descrição',
                'lines' => 'Linhas',
            ...
            'auto-post' => [
                'invoice' => 'Lançado automaticamente para a fatura :invoice',
                'payment' => 'Pagamento lançado automaticamente para a fatura :invoice',
                'refund' => 'Lançado automaticamente para o reembolso #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'O lançamento não está balanceado. O total de débitos deve ser igual ao total de créditos.',
                'only-draft-can-be-posted' => 'Somente lançamentos em rascunho podem ser registrados.',
                'only-posted-can-be-voided' => 'Somente lançamentos registrados podem ser anulados.',
            ],
            'create-success' => 'Lançamento contábil criado com sucesso.',
            'post-success' => 'Lançamento contábil registrado com sucesso.',
            'void-success' => 'Lançamento contábil anulado com sucesso.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Livro razão',
                ...
                'credit' => 'Crédito',
                'balance' => 'Saldo',
                'no-transactions' => 'Nenhuma transação encontrada para o período selecionado.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Anos fiscais',
                'create-btn' => 'Criar ano fiscal',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Código',
                    'start-date' => 'Data inicial',
            ...
            'create' => [
                'title' => 'Criar ano fiscal',
                'back-btn' => 'Voltar',
                'save-btn' => 'Salvar ano fiscal',
                'code' => 'Código',
            ...
            'create-success' => 'Ano fiscal criado com sucesso.',
            'close-success' => 'Ano fiscal fechado com sucesso.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Configurações de contabilidade',
                'save-btn' => 'Salvar configurações',
                'mapping-title' => 'Mapeamento de contas padrão',
                'mapping-info' => 'Associe as contas usadas para lançar automaticamente os lançamentos contábeis ao criar faturas, pagamentos e reembolsos.',
                'accounts-receivable-account' => 'Conta de contas a receber',
                'cash-bank-account' => 'Conta caixa / banco',
                'sales-revenue-account' => 'Conta de receita de vendas',
                'shipping-revenue-account' => 'Conta de receita de frete',
                'sales-discount-account' => 'Conta de descontos de vendas',
                'sales-refund-account' => 'Conta de reembolsos de vendas',
                'tax-payable-account' => 'Conta de impostos a pagar',
                'not-mapped' => 'Não mapeado',
            ],
            'update-success' => 'Configurações de contabilidade atualizadas com sucesso.',
        ],
        'reports' => [
            'trial-balance' => [
            ...
            'balance-sheet' => [
                ...
                'total-equity' => 'Total do patrimônio líquido',
                'current-earnings' => 'Resultado do período',
                'total-liabilities-and-equity' => 'Total de passivos e patrimônio líquido',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Configure as definições do gateway de pagamento iyzico. Após salvar, defina a URL de retorno nas configurações de integração do seu painel iyzico como your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Insira sua chave secreta obtida no painel do iyzico',
                    'local-payment' => 'Pagamento Local',
                    'local-payment-info' => 'Um modelo de método de pagamento manual local que pode ser personalizado conforme necessário.',
                    'logo' => 'Logotipo',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Configure as definições do gateway de pagamento PayTR. Após salvar, defina a URL de notificação no seu painel de comerciante PayTR como your-shop-url/paytr/notify — o PayTR exige que isso seja definido manualmente.',
                    'paytr-merchant-id-info' => 'Insira seu ID de comerciante obtido no painel do PayTR',
                    'paytr-merchant-key-info' => 'Insira sua chave de comerciante obtida no painel do PayTR',
                    'paytr-merchant-salt-info' => 'Insira seu salt de comerciante obtido no painel do PayTR',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Configurações',
    ...
    'acl' => [
        ...
        'accounting-close' => 'Fechar',
        'accounting-fiscal-years' => 'Anos fiscais',
        'accounting-journal-entries' => 'Lançamentos contábeis',
        'accounting-ledger' => 'Livro razão',
        'accounting-post' => 'Registrar',
        'accounting-reports' => 'Relatórios',
        'accounting-settings' => 'Configurações',
        'accounting-void' => 'Anular',
        'addresses' => 'Endereços',
        'attribute-families' => 'Famílias de Atributos',
        'attributes' => 'Atributos',
        'campaigns' => 'Campanhas',
