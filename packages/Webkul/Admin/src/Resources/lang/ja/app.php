...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => '勘定科目を作成しました。',
            'update-success' => '勘定科目を更新しました。',
            'delete-success' => '勘定科目を削除しました。',
            'system-account-error' => 'これは保護されたシステム勘定科目のため削除できません。',
            'in-use-error' => 'この勘定科目には子科目または仕訳が存在するため削除できません。',
        ],
        'journal-entries' => [
            'index' => [
                'title' => '仕訳帳',
            ...
            'create' => [
                'title' => '仕訳を作成',
                'back-btn' => '戻る',
                'save-draft-btn' => '下書きとして保存',
                'save-post-btn' => '保存して計上',
                'general' => '一般',
                'entry-date' => '仕訳日',
                'description' => '説明',
                'lines' => '明細行',
            ...
            'auto-post' => [
                'invoice' => '請求書 :invoice のため自動計上されました',
                'payment' => '請求書 :invoice の入金が自動計上されました',
                'refund' => '返金 #:refund のため自動計上されました',
            ],
            'errors' => [
                'unbalanced-entry' => '仕訳の貸借が一致していません。借方合計と貸方合計は一致する必要があります。',
                'only-draft-can-be-posted' => '下書きの仕訳のみ計上できます。',
                'only-posted-can-be-voided' => '計上済みの仕訳のみ無効にできます。',
            ],
            'create-success' => '仕訳を作成しました。',
            'post-success' => '仕訳を計上しました。',
            'void-success' => '仕訳を無効にしました。',
        ],
        'ledger' => [
            'index' => [
                'title' => '総勘定元帳',
                ...
                'credit' => '貸方',
                'balance' => '残高',
                'no-transactions' => '選択した期間の取引が見つかりません。',
            ],
        ],
        'fiscal-years' => [
            'index' => [
            ...
            'create-success' => '会計年度を作成しました。',
            'close-success' => '会計年度を締めました。',
        ],
        'settings' => [
            'edit' => [
                'title' => '会計設定',
                'save-btn' => '設定を保存',
                'mapping-title' => 'デフォルトの勘定科目マッピング',
                'mapping-info' => '請求書、支払い、返金の作成時に仕訳を自動計上するために使用する勘定科目を設定します。',
                'accounts-receivable-account' => '売掛金勘定',
                'cash-bank-account' => '現金・銀行勘定',
                'sales-revenue-account' => '売上高勘定',
                'shipping-revenue-account' => '送料収益勘定',
                'sales-discount-account' => '売上値引勘定',
                'sales-refund-account' => '売上返金勘定',
                'tax-payable-account' => '未払税金勘定',
                'not-mapped' => '未設定',
            ],
            'update-success' => '会計設定を更新しました。',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => '試算表',
            ...
            'balance-sheet' => [
                ...
                'total-equity' => '純資産合計',
                'current-earnings' => '当期純利益',
                'total-liabilities-and-equity' => '負債・純資産合計',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'instructions' => '指示',
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'iyzico決済ゲートウェイの設定を行います。保存後、iyzicoダッシュボードの連携設定でコールバックURLをyour-shop-url/iyzico/callbackに設定してください。',
                    'iyzico-secret-key-info' => 'iyzicoダッシュボードから取得したシークレットキーを入力してください',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'PayTR決済ゲートウェイの設定を行います。保存後、PayTRマーチャントパネルの通知URLをyour-shop-url/paytr/notifyに設定してください — PayTRはこれを手動で設定する必要があります。',
                    'paytr-merchant-id-info' => 'PayTRパネルから取得したMerchant IDを入力してください',
                    'paytr-merchant-key-info' => 'PayTRパネルから取得したMerchant Keyを入力してください',
                    'paytr-merchant-salt-info' => 'PayTRパネルから取得したMerchant Saltを入力してください',
                    'payu' => 'PayU',
    ...
    'acl' => [
        'accounting' => '会計',
        'accounting-accounts' => '勘定科目表',
        'accounting-close' => '締める',
        'accounting-fiscal-years' => '会計年度',
        'accounting-journal-entries' => '仕訳帳',
        'accounting-ledger' => '総勘定元帳',
        'accounting-post' => '計上',
        'accounting-reports' => 'レポート',
        'accounting-settings' => '設定',
        'accounting-void' => '無効化',
        'addresses' => '住所',
        'attribute-families' => '属性ファミリー',
