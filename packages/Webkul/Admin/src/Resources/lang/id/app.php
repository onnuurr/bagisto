...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'Akun berhasil dibuat.',
            'update-success' => 'Akun berhasil diperbarui.',
            'delete-success' => 'Akun berhasil dihapus.',
            'system-account-error' => 'Ini adalah akun sistem yang dilindungi dan tidak dapat dihapus.',
            'in-use-error' => 'Akun ini memiliki subakun atau jurnal dan tidak dapat dihapus.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Jurnal',
                'create-btn' => 'Buat Jurnal',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Nomor Jurnal',
                    'entry-date' => 'Tanggal Jurnal',
                    'reference-type' => 'Referensi',
                    'description' => 'Deskripsi',
                    'total' => 'Total',
                    'status' => 'Status',
                    'view' => 'Lihat',
            ...
            'create' => [
                'title' => 'Buat Jurnal',
                'back-btn' => 'Kembali',
                'save-draft-btn' => 'Simpan sebagai Draf',
                'save-post-btn' => 'Simpan & Posting',
                'general' => 'Umum',
                'entry-date' => 'Tanggal Jurnal',
                'description' => 'Deskripsi',
                'lines' => 'Baris',
                'account' => 'Akun',
                'line-description' => 'Deskripsi',
                'debit' => 'Debit',
                'credit' => 'Kredit',
            ...
            'auto-post' => [
                'invoice' => 'Diposting otomatis untuk faktur :invoice',
                'payment' => 'Pembayaran diposting otomatis untuk faktur :invoice',
                'refund' => 'Diposting otomatis untuk pengembalian dana #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'Jurnal tidak seimbang. Total debit harus sama dengan total kredit.',
                'only-draft-can-be-posted' => 'Hanya jurnal berstatus draf yang dapat diposting.',
                'only-posted-can-be-voided' => 'Hanya jurnal yang sudah diposting yang dapat dibatalkan.',
            ],
            'create-success' => 'Jurnal berhasil dibuat.',
            'post-success' => 'Jurnal berhasil diposting.',
            'void-success' => 'Jurnal berhasil dibatalkan.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Buku Besar',
                ...
                'credit' => 'Kredit',
                'balance' => 'Saldo',
                'no-transactions' => 'Tidak ada transaksi ditemukan untuk periode yang dipilih.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Tahun Fiskal',
                'create-btn' => 'Buat Tahun Fiskal',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Kode',
                    'start-date' => 'Tanggal Mulai',
            ...
            'create' => [
                'title' => 'Buat Tahun Fiskal',
                'back-btn' => 'Kembali',
                'save-btn' => 'Simpan Tahun Fiskal',
                'code' => 'Kode',
                'code-placeholder' => 'mis. TF2026',
                'start-date' => 'Tanggal Mulai',
                'end-date' => 'Tanggal Akhir',
            ],
            'statuses' => [
            ...
            'create-success' => 'Tahun fiskal berhasil dibuat.',
            'close-success' => 'Tahun fiskal berhasil ditutup.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Pengaturan Akuntansi',
                'save-btn' => 'Simpan Pengaturan',
                'mapping-title' => 'Pemetaan Akun Default',
                'mapping-info' => 'Petakan akun yang digunakan untuk memposting jurnal secara otomatis saat faktur, pembayaran, dan pengembalian dana dibuat.',
                'accounts-receivable-account' => 'Akun Piutang',
                'cash-bank-account' => 'Akun Kas / Bank',
                'sales-revenue-account' => 'Akun Pendapatan Penjualan',
                'shipping-revenue-account' => 'Akun Pendapatan Pengiriman',
                'sales-discount-account' => 'Akun Diskon Penjualan',
                'sales-refund-account' => 'Akun Pengembalian Dana Penjualan',
                'tax-payable-account' => 'Akun Utang Pajak',
                'not-mapped' => 'Belum Dipetakan',
            ],
            'update-success' => 'Pengaturan akuntansi berhasil diperbarui.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Neraca Saldo',
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => 'Laba Periode Berjalan',
                'total-liabilities-and-equity' => 'Total Liabilitas & Ekuitas',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Konfigurasikan pengaturan gateway pembayaran iyzico. Setelah menyimpan, atur URL Callback di pengaturan integrasi dasbor iyzico Anda ke your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Masukkan Secret Key Anda yang diperoleh dari dasbor iyzico',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Konfigurasikan pengaturan gateway pembayaran PayTR. Setelah menyimpan, atur URL Notifikasi di panel merchant PayTR Anda ke your-shop-url/paytr/notify — PayTR mengharuskan ini diatur secara manual.',
                    'paytr-merchant-id-info' => 'Masukkan Merchant ID Anda yang diperoleh dari panel PayTR',
                    'paytr-merchant-key-info' => 'Masukkan Merchant Key Anda yang diperoleh dari panel PayTR',
                    'paytr-merchant-salt-info' => 'Masukkan Merchant Salt Anda yang diperoleh dari panel PayTR',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Pengaturan',
                'chart-of-accounts' => 'Bagan Akun',
                'fiscal-years' => 'Tahun Fiskal',
    ...
    'acl' => [
        'accounting' => 'Akuntansi',
        'accounting-accounts' => 'Bagan Akun',
        'accounting-close' => 'Tutup',
        'accounting-fiscal-years' => 'Tahun Fiskal',
        'accounting-journal-entries' => 'Jurnal',
        'accounting-ledger' => 'Buku Besar',
        'accounting-post' => 'Posting',
        'accounting-reports' => 'Laporan',
        'accounting-settings' => 'Pengaturan',
        'accounting-void' => 'Batalkan',
        'addresses' => 'Alamat',
        'attribute-families' => 'Keluarga Atribut',
        'attributes' => 'Atribut',
        'campaigns' => 'Kampanye',
