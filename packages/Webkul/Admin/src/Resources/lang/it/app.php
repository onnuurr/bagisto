...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create' => [
                'title' => 'Crea conto',
                'back-btn' => 'Indietro',
                'save-btn' => 'Salva conto',
                'general' => 'Generale',
                'code' => 'Codice',
                'name' => 'Nome',
                'type' => 'Tipo',
                'parent' => 'Conto padre',
                'no-parent' => 'Nessun conto padre',
                'opening-balance' => 'Saldo iniziale',
                'status' => 'Stato',
                'description' => 'Descrizione',
            ],
            ...
            'create-success' => 'Conto creato con successo.',
            'update-success' => 'Conto aggiornato con successo.',
            'delete-success' => 'Conto eliminato con successo.',
            'system-account-error' => 'Questo è un conto di sistema protetto e non può essere eliminato.',
            'in-use-error' => 'Questo conto ha sottoconti o registrazioni contabili e non può essere eliminato.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Registrazioni contabili',
                'create-btn' => 'Crea registrazione contabile',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Numero registrazione',
                    'entry-date' => 'Data registrazione',
                    'reference-type' => 'Riferimento',
                    'description' => 'Descrizione',
                    'total' => 'Totale',
                    'status' => 'Stato',
                    'view' => 'Visualizza',
            ...
            'create' => [
                'title' => 'Crea registrazione contabile',
                'back-btn' => 'Indietro',
                'save-draft-btn' => 'Salva come bozza',
                'save-post-btn' => 'Salva e registra',
                'general' => 'Generale',
                'entry-date' => 'Data registrazione',
                'description' => 'Descrizione',
                'lines' => 'Righe',
                'account' => 'Conto',
                'line-description' => 'Descrizione',
                'debit' => 'Dare',
                'credit' => 'Avere',
            ...
            'auto-post' => [
                'invoice' => 'Registrato automaticamente per la fattura :invoice',
                'payment' => 'Pagamento registrato automaticamente per la fattura :invoice',
                'refund' => 'Registrato automaticamente per il rimborso #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'La registrazione non è bilanciata. Il totale dare deve essere uguale al totale avere.',
                'only-draft-can-be-posted' => 'Solo le registrazioni in bozza possono essere registrate.',
                'only-posted-can-be-voided' => 'Solo le registrazioni registrate possono essere annullate.',
            ],
            'create-success' => 'Registrazione contabile creata con successo.',
            'post-success' => 'Registrazione contabile registrata con successo.',
            'void-success' => 'Registrazione contabile annullata con successo.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Libro mastro',
                ...
                'credit' => 'Avere',
                'balance' => 'Saldo',
                'no-transactions' => 'Nessuna transazione trovata per il periodo selezionato.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Anni fiscali',
                'create-btn' => 'Crea anno fiscale',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Codice',
                    'start-date' => 'Data di inizio',
            ...
            'create' => [
                'title' => 'Crea anno fiscale',
                'back-btn' => 'Indietro',
                'save-btn' => 'Salva anno fiscale',
                'code' => 'Codice',
                'code-placeholder' => 'es. AF2026',
                'start-date' => 'Data di inizio',
                'end-date' => 'Data di fine',
            ],
            'statuses' => [
            ...
            'create-success' => 'Anno fiscale creato con successo.',
            'close-success' => 'Anno fiscale chiuso con successo.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Impostazioni contabilità',
                'save-btn' => 'Salva impostazioni',
                'mapping-title' => 'Mappatura conti predefinita',
                'mapping-info' => 'Associa i conti utilizzati per registrare automaticamente le scritture contabili alla creazione di fatture, pagamenti e rimborsi.',
                'accounts-receivable-account' => 'Conto crediti verso clienti',
                'cash-bank-account' => 'Conto cassa / banca',
                'sales-revenue-account' => 'Conto ricavi di vendita',
                'shipping-revenue-account' => 'Conto ricavi di spedizione',
                'sales-discount-account' => 'Conto sconti di vendita',
                'sales-refund-account' => 'Conto rimborsi di vendita',
                'tax-payable-account' => 'Conto imposte da versare',
                'not-mapped' => 'Non mappato',
            ],
            'update-success' => 'Impostazioni contabilità aggiornate con successo.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Bilancio di verifica',
                'as-of-date' => 'Alla data del',
                'filter-btn' => 'Filtra',
                'code' => 'Codice',
                'account' => 'Conto',
                'debit' => 'Dare',
            ...
            'balance-sheet' => [
                ...
                'equity' => 'Patrimonio netto',
                'total-assets' => 'Totale attività',
                'total-liabilities' => 'Totale passività',
                'total-equity' => 'Totale patrimonio netto',
                'current-earnings' => 'Utile del periodo',
                'total-liabilities-and-equity' => 'Totale passività e patrimonio netto',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Configura le impostazioni del gateway di pagamento iyzico. Dopo il salvataggio, imposta l\'URL di callback nelle impostazioni di integrazione della tua dashboard iyzico su your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Inserisci la tua chiave segreta ottenuta dalla dashboard iyzico',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Configura le impostazioni del gateway di pagamento PayTR. Dopo il salvataggio, imposta l\'URL di notifica nel tuo pannello commerciante PayTR su your-shop-url/paytr/notify — PayTR richiede che questo venga impostato manualmente.',
                    'paytr-merchant-id-info' => 'Inserisci il tuo ID commerciante ottenuto dal pannello PayTR',
                    'paytr-merchant-key-info' => 'Inserisci la tua chiave commerciante ottenuta dal pannello PayTR',
                    'paytr-merchant-salt-info' => 'Inserisci il tuo salt commerciante ottenuto dal pannello PayTR',
                    'payu' => 'PayU',
    ...
    'acl' => [
        'accounting' => 'Contabilità',
        'accounting-accounts' => 'Piano dei conti',
        'accounting-close' => 'Chiudi',
        'accounting-fiscal-years' => 'Anni fiscali',
        'accounting-journal-entries' => 'Registrazioni contabili',
        'accounting-ledger' => 'Libro mastro',
        'accounting-post' => 'Registra',
        'accounting-reports' => 'Report',
        'accounting-settings' => 'Impostazioni',
        'accounting-void' => 'Annulla',
        'addresses' => 'Indirizzi',
        'attribute-families' => 'Famiglie di Attributi',
        'attributes' => 'Attributi',
        'campaigns' => 'Campagne',
