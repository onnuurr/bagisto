...
return [
    ...
    'accounting' => [
        'accounts' => [
            'index' => [
                ...
                'create-btn' => 'Rekening aanmaken',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Code',
                    'name' => 'Naam',
                    'parent' => 'Hoofdrekening',
                    'type' => 'Type',
            ...
            'create' => [
                'title' => 'Rekening aanmaken',
                'back-btn' => 'Terug',
                'save-btn' => 'Rekening opslaan',
                'general' => 'Algemeen',
                'code' => 'Code',
                'name' => 'Naam',
                'type' => 'Type',
                'parent' => 'Hoofdrekening',
                'no-parent' => 'Geen hoofdrekening',
                'opening-balance' => 'Beginsaldo',
                'status' => 'Status',
                'description' => 'Omschrijving',
            ],
            ...
            'create-success' => 'Rekening succesvol aangemaakt.',
            'update-success' => 'Rekening succesvol bijgewerkt.',
            'delete-success' => 'Rekening succesvol verwijderd.',
            'system-account-error' => 'Dit is een beschermde systeemrekening en kan niet worden verwijderd.',
            'in-use-error' => 'Deze rekening heeft subrekeningen of journaalposten en kan niet worden verwijderd.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Journaalposten',
                'create-btn' => 'Journaalpost aanmaken',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Boekingsnummer',
                    'entry-date' => 'Boekingsdatum',
            ...
            'create' => [
                'title' => 'Journaalpost aanmaken',
                'back-btn' => 'Terug',
                'save-draft-btn' => 'Opslaan als concept',
                'save-post-btn' => 'Opslaan & boeken',
                'general' => 'Algemeen',
                'entry-date' => 'Boekingsdatum',
                'description' => 'Omschrijving',
                'lines' => 'Regels',
                'account' => 'Rekening',
                'line-description' => 'Omschrijving',
                'debit' => 'Debet',
                'credit' => 'Credit',
            ...
            'auto-post' => [
                'invoice' => 'Automatisch geboekt voor factuur :invoice',
                'payment' => 'Betaling automatisch geboekt voor factuur :invoice',
                'refund' => 'Automatisch geboekt voor terugbetaling #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'De journaalpost is niet in balans. Het totaal debet moet gelijk zijn aan het totaal credit.',
                'only-draft-can-be-posted' => 'Alleen conceptjournaalposten kunnen worden geboekt.',
                'only-posted-can-be-voided' => 'Alleen geboekte journaalposten kunnen worden geannuleerd.',
            ],
            'create-success' => 'Journaalpost succesvol aangemaakt.',
            'post-success' => 'Journaalpost succesvol geboekt.',
            'void-success' => 'Journaalpost succesvol geannuleerd.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Grootboek',
                ...
                'credit' => 'Credit',
                'balance' => 'Saldo',
                'no-transactions' => 'Geen transacties gevonden voor de geselecteerde periode.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Boekjaren',
                'create-btn' => 'Boekjaar aanmaken',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Code',
                    'start-date' => 'Startdatum',
            ...
            'create' => [
                'title' => 'Boekjaar aanmaken',
                'back-btn' => 'Terug',
                'save-btn' => 'Boekjaar opslaan',
                'code' => 'Code',
                'code-placeholder' => 'bijv. BJ2026',
                'start-date' => 'Startdatum',
                'end-date' => 'Einddatum',
            ],
            'statuses' => [
            ...
            'create-success' => 'Boekjaar succesvol aangemaakt.',
            'close-success' => 'Boekjaar succesvol afgesloten.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Boekhoudinstellingen',
                'save-btn' => 'Instellingen opslaan',
                'mapping-title' => 'Standaard rekeningtoewijzing',
                'mapping-info' => 'Wijs de rekeningen toe die worden gebruikt om automatisch journaalposten te boeken bij facturen, betalingen en terugbetalingen.',
                'accounts-receivable-account' => 'Debiteurenrekening',
                'cash-bank-account' => 'Kas-/bankrekening',
                'sales-revenue-account' => 'Verkoopomzetrekening',
                'shipping-revenue-account' => 'Verzendomzetrekening',
                'sales-discount-account' => 'Verkoopkortingrekening',
                'sales-refund-account' => 'Verkoopterugbetalingsrekening',
                'tax-payable-account' => 'Te betalen btw-rekening',
                'not-mapped' => 'Niet toegewezen',
            ],
            'update-success' => 'Boekhoudinstellingen succesvol bijgewerkt.',
        ],
        'reports' => [
            'trial-balance' => [
            ...
            'balance-sheet' => [
                ...
                'total-liabilities' => 'Totale verplichtingen',
                'total-equity' => 'Totaal eigen vermogen',
                'current-earnings' => 'Resultaat van de periode',
                'total-liabilities-and-equity' => 'Totaal verplichtingen & eigen vermogen',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Configureer de iyzico-betaalgateway-instellingen. Stel na het opslaan de callback-URL in uw iyzico-dashboardintegratie-instellingen in op your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Voer uw geheime sleutel in die u van het iyzico-dashboard hebt gekregen',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Configureer de PayTR-betaalgateway-instellingen. Stel na het opslaan de meldings-URL in uw PayTR-handelaarspaneel in op your-shop-url/paytr/notify — PayTR vereist dat dit handmatig wordt ingesteld.',
                    'paytr-merchant-id-info' => 'Voer uw Merchant ID in dat u van het PayTR-paneel hebt gekregen',
                    'paytr-merchant-key-info' => 'Voer uw Merchant Key in die u van het PayTR-paneel hebt gekregen',
                    'paytr-merchant-salt-info' => 'Voer uw Merchant Salt in die u van het PayTR-paneel hebt gekregen',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Instellingen',
                'chart-of-accounts' => 'Rekeningschema',
                'fiscal-years' => 'Boekjaren',
    ...
    'acl' => [
        'accounting' => 'Boekhouding',
        'accounting-accounts' => 'Rekeningschema',
        'accounting-close' => 'Afsluiten',
        'accounting-fiscal-years' => 'Boekjaren',
        'accounting-journal-entries' => 'Journaalposten',
        'accounting-ledger' => 'Grootboek',
        'accounting-post' => 'Boeken',
        'accounting-reports' => 'Rapporten',
        'accounting-settings' => 'Instellingen',
        'accounting-void' => 'Annuleren',
        'addresses' => 'Adressen',
