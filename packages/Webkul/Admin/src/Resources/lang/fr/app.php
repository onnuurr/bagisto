...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'Compte créé avec succès.',
            'update-success' => 'Compte mis à jour avec succès.',
            'delete-success' => 'Compte supprimé avec succès.',
            'system-account-error' => 'Il s\'agit d\'un compte système protégé qui ne peut pas être supprimé.',
            'in-use-error' => 'Ce compte possède des sous-comptes ou des écritures et ne peut pas être supprimé.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Écritures comptables',
                'create-btn' => 'Créer une écriture comptable',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Numéro d\'écriture',
                    'entry-date' => 'Date de l\'écriture',
                    'reference-type' => 'Référence',
                    'description' => 'Description',
                    'total' => 'Total',
                    'status' => 'Statut',
                    'view' => 'Voir',
            ...
            'create' => [
                ...
                'back-btn' => 'Retour',
                'save-draft-btn' => 'Enregistrer comme brouillon',
                'save-post-btn' => 'Enregistrer et comptabiliser',
                'general' => 'Général',
                'entry-date' => 'Date de l\'écriture',
                'description' => 'Description',
                'lines' => 'Lignes',
            ...
            'auto-post' => [
                'invoice' => 'Comptabilisé automatiquement pour la facture :invoice',
                'payment' => 'Paiement comptabilisé automatiquement pour la facture :invoice',
                'refund' => 'Comptabilisé automatiquement pour le remboursement #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'L\'écriture n\'est pas équilibrée. Le total des débits doit être égal au total des crédits.',
                'only-draft-can-be-posted' => 'Seules les écritures en brouillon peuvent être comptabilisées.',
                'only-posted-can-be-voided' => 'Seules les écritures comptabilisées peuvent être annulées.',
            ],
            'create-success' => 'Écriture comptable créée avec succès.',
            'post-success' => 'Écriture comptable comptabilisée avec succès.',
            'void-success' => 'Écriture comptable annulée avec succès.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Grand livre',
                ...
                'credit' => 'Crédit',
                'balance' => 'Solde',
                'no-transactions' => 'Aucune transaction trouvée pour la période sélectionnée.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Exercices fiscaux',
                'create-btn' => 'Créer un exercice fiscal',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Code',
                    'start-date' => 'Date de début',
            ...
            'create' => [
                ...
                'back-btn' => 'Retour',
                'save-btn' => 'Enregistrer l\'exercice fiscal',
                'code' => 'Code',
                'code-placeholder' => 'ex. EF2026',
                'start-date' => 'Date de début',
                'end-date' => 'Date de fin',
            ],
            'statuses' => [
            ...
            'create-success' => 'Exercice fiscal créé avec succès.',
            'close-success' => 'Exercice fiscal clôturé avec succès.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Paramètres de comptabilité',
                'save-btn' => 'Enregistrer les paramètres',
                'mapping-title' => 'Mappage des comptes par défaut',
                'mapping-info' => 'Associez les comptes utilisés pour comptabiliser automatiquement les écritures lors de la création de factures, paiements et remboursements.',
                'accounts-receivable-account' => 'Compte clients',
                'cash-bank-account' => 'Compte caisse / banque',
                'sales-revenue-account' => 'Compte de produits des ventes',
                'shipping-revenue-account' => 'Compte de produits de livraison',
                'sales-discount-account' => 'Compte de remises sur ventes',
                'sales-refund-account' => 'Compte de remboursements sur ventes',
                'tax-payable-account' => 'Compte de taxes à payer',
                'not-mapped' => 'Non associé',
            ],
            'update-success' => 'Paramètres de comptabilité mis à jour avec succès.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Balance générale',
                'as-of-date' => 'À la date du',
                'filter-btn' => 'Filtrer',
                'code' => 'Code',
                'account' => 'Compte',
                'debit' => 'Débit',
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => 'Résultat de la période',
                'total-liabilities-and-equity' => 'Total passifs et capitaux propres',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Configurez les paramètres de la passerelle de paiement iyzico. Après l\'enregistrement, définissez l\'URL de rappel dans les paramètres d\'intégration de votre tableau de bord iyzico sur your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Saisissez votre clé secrète obtenue depuis le tableau de bord iyzico',
                    'local-payment' => 'Paiement local',
                    'local-payment-info' => 'Un modèle de méthode de paiement manuel local que vous pouvez personnaliser selon vos besoins.',
                    'logo' => 'Logo',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Configurez les paramètres de la passerelle de paiement PayTR. Après l\'enregistrement, définissez l\'URL de notification dans votre panneau marchand PayTR sur your-shop-url/paytr/notify — PayTR exige que cela soit défini manuellement.',
                    'paytr-merchant-id-info' => 'Saisissez votre ID marchand obtenu depuis le panneau PayTR',
                    'paytr-merchant-key-info' => 'Saisissez votre clé marchand obtenue depuis le panneau PayTR',
                    'paytr-merchant-salt-info' => 'Saisissez votre sel marchand obtenu depuis le panneau PayTR',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Paramètres',
