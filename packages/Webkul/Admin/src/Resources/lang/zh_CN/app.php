...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => '科目创建成功。',
            'update-success' => '科目更新成功。',
            'delete-success' => '科目删除成功。',
            'system-account-error' => '这是受保护的系统科目，无法删除。',
            'in-use-error' => '该科目下存在下级科目或凭证记录，无法删除。',
        ],
        'journal-entries' => [
            'index' => [
                'title' => '凭证',
            ...
            'auto-post' => [
                'invoice' => '已为发票 :invoice 自动过账',
                'payment' => '已为发票 :invoice 自动过账付款',
                'refund' => '已为退款 #:refund 自动过账',
            ],
            'errors' => [
                'unbalanced-entry' => '凭证借贷不平衡，借方合计必须等于贷方合计。',
                'only-draft-can-be-posted' => '只有草稿状态的凭证才能过账。',
                'only-posted-can-be-voided' => '只有已过账的凭证才能作废。',
            ],
        ...
        'fiscal-years' => [
            ...
            'create-success' => '会计年度创建成功。',
            'close-success' => '会计年度结账成功。',
        ],
        'settings' => [
            'edit' => [
                'title' => '会计设置',
                'save-btn' => '保存设置',
                'mapping-title' => '默认科目映射',
                'mapping-info' => '映射在创建发票、付款和退款时自动过账凭证所使用的科目。',
                'accounts-receivable-account' => '应收账款科目',
                'cash-bank-account' => '现金/银行科目',
                'sales-revenue-account' => '销售收入科目',
                'shipping-revenue-account' => '运费收入科目',
                'sales-discount-account' => '销售折扣科目',
                'sales-refund-account' => '销售退款科目',
                'tax-payable-account' => '应交税金科目',
                'not-mapped' => '未映射',
            ],
            'update-success' => '会计设置更新成功。',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => '试算平衡表',
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => '本期损益',
                'total-liabilities-and-equity' => '负债和所有者权益合计',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'instructions' => '说明',
                    'iyzico' => 'iyzico',
                    'iyzico-info' => '配置 iyzico 支付网关设置。保存后，请在您的 iyzico 仪表板集成设置中将回调网址设置为 your-shop-url/iyzico/callback。',
                    'iyzico-secret-key-info' => '输入您从 iyzico 仪表板获取的密钥',
                    'local-payment' => '本地支付',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => '配置 PayTR 支付网关设置。保存后，请在您的 PayTR 商户面板中将通知网址设置为 your-shop-url/paytr/notify — PayTR 要求手动设置此项。',
                    'paytr-merchant-id-info' => '输入您从 PayTR 面板获取的商户 ID',
                    'paytr-merchant-key-info' => '输入您从 PayTR 面板获取的商户密钥',
                    'paytr-merchant-salt-info' => '输入您从 PayTR 面板获取的商户盐值',
                    'payu' => 'PayU',
    ...
    'acl' => [
        'accounting' => '会计',
        'accounting-accounts' => '会计科目表',
        'accounting-close' => '结账',
        'accounting-fiscal-years' => '会计年度',
        'accounting-journal-entries' => '凭证',
        'accounting-ledger' => '总账',
        'accounting-post' => '过账',
        'accounting-reports' => '报表',
        'accounting-settings' => '设置',
        'accounting-void' => '作废',
        'addresses' => '地址',
