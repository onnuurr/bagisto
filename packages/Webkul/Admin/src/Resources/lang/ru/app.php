            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    ...
                    'aras-kargo' => [
                        ...
                        'status' => 'Статус',
                        'title' => 'Название',
                        'title-info' => 'Рассчитывает стоимость доставки через API Aras Kargo с использованием учётных данных вашего аккаунта и использует фиксированный резервный тариф, если API недоступен.',
                        'username' => 'Имя пользователя',
                        'wsdl-url' => 'URL-адрес WSDL',
                        'rate' => 'Ставка',
                    ],
                    ...
                    'kargonomi' => [
                        ...
                        'shipping-provider-id' => 'ID предпочитаемого перевозчика',
                        'status' => 'Статус',
                        'title' => 'Название',
                        'title-info' => 'Рассчитывает актуальный тариф доставки через сравнение нескольких перевозчиков Kargonomi, создавая черновик отправления для корзины и считывая его расценку, и использует фиксированный резервный тариф, если API недоступен.',
