...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create' => [
                'title' => 'Создать счёт',
                'back-btn' => 'Назад',
                'save-btn' => 'Сохранить счёт',
                'general' => 'Общее',
                'code' => 'Код',
                'name' => 'Название',
                'type' => 'Тип',
                'parent' => 'Родительский счёт',
                'no-parent' => 'Без родительского счёта',
                'opening-balance' => 'Начальное сальдо',
                'status' => 'Статус',
                'description' => 'Описание',
            ],
            ...
            'create-success' => 'Счёт успешно создан.',
            'update-success' => 'Счёт успешно обновлён.',
            'delete-success' => 'Счёт успешно удалён.',
            'system-account-error' => 'Это защищённый системный счёт, его нельзя удалить.',
            'in-use-error' => 'У этого счёта есть дочерние счета или проводки, поэтому его нельзя удалить.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Проводки',
                'create-btn' => 'Создать проводку',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Номер проводки',
                    'entry-date' => 'Дата проводки',
                    'reference-type' => 'Ссылка',
                    'description' => 'Описание',
                    'total' => 'Итого',
                    'status' => 'Статус',
                    'view' => 'Просмотр',
            ...
            'create' => [
                ...
                'back-btn' => 'Назад',
                'save-draft-btn' => 'Сохранить как черновик',
                'save-post-btn' => 'Сохранить и провести',
                'general' => 'Общее',
                'entry-date' => 'Дата проводки',
                'description' => 'Описание',
                'lines' => 'Строки',
                ...
                'debit' => 'Дебет',
                'credit' => 'Кредит',
                'select-account' => 'Выбрать счёт',
                'add-line' => 'Добавить строку',
            ],
            'view' => [
                'back-btn' => 'Назад',
                'post-btn' => 'Провести',
                'void-btn' => 'Аннулировать',
                'entry-date' => 'Дата проводки',
                'status' => 'Статус',
                'reference-type' => 'Ссылка',
                'currency' => 'Валюта',
            ...
            'auto-post' => [
                'invoice' => 'Автоматически проведено для счёта :invoice',
                'payment' => 'Платёж автоматически проведён для счёта :invoice',
                'refund' => 'Автоматически проведено для возврата #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'Проводка не сбалансирована. Сумма дебета должна быть равна сумме кредита.',
                'only-draft-can-be-posted' => 'Провести можно только проводки в статусе черновика.',
                'only-posted-can-be-voided' => 'Аннулировать можно только проведённые проводки.',
            ],
            'create-success' => 'Проводка успешно создана.',
            'post-success' => 'Проводка успешно проведена.',
            'void-success' => 'Проводка успешно аннулирована.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Главная книга',
                ...
                'credit' => 'Кредит',
                'balance' => 'Баланс',
                'no-transactions' => 'За выбранный период транзакции не найдены.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Финансовые годы',
                'create-btn' => 'Создать финансовый год',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Код',
                    'start-date' => 'Дата начала',
            ...
            'create' => [
                'title' => 'Создать финансовый год',
                'back-btn' => 'Назад',
                'save-btn' => 'Сохранить финансовый год',
                'code' => 'Код',
                'code-placeholder' => 'напр. ФГ2026',
                'start-date' => 'Дата начала',
                'end-date' => 'Дата окончания',
            ],
            'statuses' => [
            ...
            'create-success' => 'Финансовый год успешно создан.',
            'close-success' => 'Финансовый год успешно закрыт.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Настройки бухгалтерии',
                'save-btn' => 'Сохранить настройки',
                'mapping-title' => 'Сопоставление счетов по умолчанию',
                'mapping-info' => 'Сопоставьте счета, используемые для автоматического проведения проводок при создании счетов, платежей и возвратов.',
                'accounts-receivable-account' => 'Счёт дебиторской задолженности',
                'cash-bank-account' => 'Касса / банковский счёт',
                'sales-revenue-account' => 'Счёт выручки от продаж',
                'shipping-revenue-account' => 'Счёт выручки от доставки',
                'sales-discount-account' => 'Счёт скидок на продажи',
                'sales-refund-account' => 'Счёт возвратов по продажам',
                'tax-payable-account' => 'Счёт налогов к уплате',
                'not-mapped' => 'Не сопоставлено',
            ],
            'update-success' => 'Настройки бухгалтерии успешно обновлены.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Оборотно-сальдовая ведомость',
                'as-of-date' => 'По состоянию на',
                'filter-btn' => 'Фильтр',
                'code' => 'Код',
                'account' => 'Счёт',
                'debit' => 'Дебет',
            ...
            'income-statement' => [
                ...
                'revenue' => 'Выручка',
                'expenses' => 'Расходы',
                'total-revenue' => 'Итого выручка',
                'total-expense' => 'Итого расходы',
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => 'Прибыль за период',
                'total-liabilities-and-equity' => 'Итого обязательства и капитал',
            ],
        ],
    ],
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Настройки',
                'chart-of-accounts' => 'План счетов',
                'fiscal-years' => 'Финансовые годы',
    ...
    'acl' => [
        ...
        'accounting-close' => 'Закрыть',
        'accounting-fiscal-years' => 'Финансовые годы',
        'accounting-journal-entries' => 'Проводки',
        'accounting-ledger' => 'Главная книга',
        'accounting-post' => 'Провести',
        'accounting-reports' => 'Отчёты',
        'accounting-settings' => 'Настройки',
        'accounting-void' => 'Аннулировать',
        'addresses' => 'Адреса',
        'attribute-families' => 'Семейства атрибутов',
        'attributes' => 'Атрибуты',
        'campaigns' => 'Кампании',
