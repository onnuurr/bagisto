...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'code-sent' => 'Отправлен новый код подтверждения.',
    ...
    'account' => [
        'edit' => [
            ...
            'method-authenticator' => 'Приложение-аутентификатор',
            'method-sms' => 'SMS',
            'phone' => 'Номер телефона',
            'send-code' => 'Отправить код',
            'two-factor-method' => 'Метод двухфакторной аутентификации',
        ],
        ...
        'messages' => [
            ...
            'code-sent-success' => 'Код подтверждения успешно отправлен.',
            'phone-required' => 'Добавьте номер телефона перед включением SMS-подтверждения.',
        ],
    ...
    'catalog' => [
        ...
        'product-tags' => [
            'index' => [
                'add-btn' => 'Создать тег товара',
                'title' => 'Теги товаров',

                'datagrid' => [
                    'delete' => 'Удалить',
                    'delete-failed' => 'Произошла ошибка при удалении тега товара',
                    'delete-success' => 'Тег товара был успешно удален.',
                    'edit' => 'Редактировать',
                    'id' => 'ID',
                    'image' => 'Изображение',
                    'mass-delete-success' => 'Выбранные теги товаров были успешно удалены',
                    'name' => 'Название',
                ],
            ],
            ...
            'create' => [
                'back-btn' => 'Назад',
                'create-success' => 'Тег товара успешно создан.',
                'general' => 'Общее',
                'image' => 'Изображение',
                'image-info' => 'Если изображение доступно, оно будет показано на товаре, иначе будет показано название в виде текстового значка.',
                'name' => 'Название',
                'save-btn' => 'Сохранить тег товара',
                'title' => 'Добавить новый тег товара',
            ],
            ...
            'edit' => [
                ...
                'name' => 'Название',
                'save-btn' => 'Сохранить тег товара',
                'title' => 'Редактировать тег товара',
                'update-success' => 'Тег товара успешно обновлен.',
            ],
        ],
    ...
    'marketing' => [
        ...
        'promotions' => [
            'index' => [
                ...
                'gift-card-title' => 'Подарочные карты',
            ],
            ...
            'gift-cards' => [
                'index' => [
                    'create-btn' => 'Создать подарочную карту',
                    ...
                    'datagrid' => [
                        ...
                        'id' => 'ID',
                        'mass-delete-success' => 'Выбранные подарочные карты успешно удалены',
                        'status' => 'Статус',
                        'unused' => 'Не использована',
                        'used' => 'Использована',
                        'used-at' => 'Дата использования',
                    ],
                ],
                ...
                'create' => [
                    'amount' => 'Сумма',
                    'code' => 'Код',
                    'code-info' => 'Оставьте пустым для автоматической генерации.',
                    'currency' => 'Валюта',
                    'customer-email' => 'Email клиента',
                    'expires-at' => 'Действует до',
                    'quantity' => 'Количество',
                    'quantity-info' => 'Количество подарочных карт для генерации. Если количество больше 1, код игнорируется и генерируется автоматически.',
                    'save-btn' => 'Сохранить подарочную карту',
                    'success' => 'Подарочная карта успешно создана',
                ...
                'edit' => [
                    ...
                    'expires-at' => 'Действует до',
                    'status' => 'Статус',
                    'success' => 'Подарочная карта успешно обновлена',
                    'title' => 'Редактировать подарочную карту',
                    'unused' => 'Не использована',
                    'used' => 'Использована',
                ],

                'delete-failed' => 'Подарочную карту нельзя удалить, так как она уже использована',
                'delete-success' => 'Подарочная карта успешно удалена',
            ],
    ...
    'settings' => [
        ...
        'email-templates' => [
            ...
            'edit' => [
                ...
                'status' => 'Статус',
                'subject' => 'Тема',
                'title' => 'Редактировать письмо-уведомление',
                'variables' => 'Доступные переменные',
                'variables-info' => 'Вы можете использовать следующие переменные в теме и содержании. Они будут автоматически заменены реальными данными при отправке письма.',
            ],

            'update-success' => 'Письмо-уведомление успешно обновлено.',
        ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Настройте параметры платёжного шлюза iyzico. После сохранения установите URL обратного вызова в настройках интеграции панели iyzico на your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Введите ваш секретный ключ, полученный на панели iyzico',
                    'local-payment' => 'Локальный платёж',
                    'local-payment-info' => 'Локальный ручной способ оплаты — шаблон, который можно настроить по мере необходимости.',
                    'logo' => 'Логотип',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Настройте параметры платёжного шлюза PayTR. После сохранения установите URL уведомлений в панели продавца PayTR на your-shop-url/paytr/notify — PayTR требует установить это вручную.',
                    'paytr-merchant-id-info' => 'Введите ваш Merchant ID, полученный на панели PayTR',
                    'paytr-merchant-key-info' => 'Введите ваш Merchant Key, полученный на панели PayTR',
                    'paytr-merchant-salt-info' => 'Введите ваш Merchant Salt, полученный на панели PayTR',
                    'payu' => 'PayU',
            ...
            'sms' => [
                'info' => 'Настройте SMS-шлюзы, уведомления о заказах и двухфакторную аутентификацию по SMS.',
                'title' => 'SMS',

                'general' => [
                    'info' => 'Общие настройки SMS.',
                    'title' => 'Общие',

                    'settings' => [
                        'active-gateway' => 'Активный шлюз',
                        'enabled' => 'Включено',
                        'title' => 'Настройки',
                        'title-info' => 'Включите или отключите SMS-уведомления во всём приложении.',
                    ],
                ],

                'gateways' => [
                    'credential-id' => 'SID аккаунта / API-ключ',
                    'credential-secret' => 'Auth Token / API-секрет',
                    'info' => 'Настройте учётные данные вашего SMS-шлюза.',
                    'sender' => 'Номер отправителя / ID отправителя',
                    'title' => 'Шлюзы',

                    'twilio' => [
                        'title' => 'Twilio',
                        'title-info' => 'Настройте учётные данные API Twilio.',
                    ],

                    'vonage' => [
                        'title' => 'Vonage',
                        'title-info' => 'Настройте учётные данные API Vonage (Nexmo).',
                    ],

                    'msg91' => [
                        'route' => 'Маршрут',
                        'title' => 'MSG91',
                        'title-info' => 'Настройте учётные данные API MSG91.',
                    ],

                    'verimor' => [
                        'title' => 'Verimor',
                        'title-info' => 'Настройте учётные данные API Verimor.',
                    ],
                ],

                'notifications' => [
                    'enabled-label' => 'Включено',
                    'info' => 'Включите SMS-уведомления для событий заказа и настройте их шаблоны сообщений.',
                    'template-label' => 'Шаблон сообщения',
                    'title' => 'Уведомления о заказах',

                    'order-placed' => [
                        'title' => 'Заказ оформлен',
                        'title-info' => 'Уведомлять клиента по SMS при оформлении заказа.',
                    ],

                    'order-shipped' => [
                        'title' => 'Заказ отправлен',
                        'title-info' => 'Уведомлять клиента по SMS при отправке его заказа.',
                    ],

                    'order-cancelled' => [
                        'title' => 'Заказ отменён',
                        'title-info' => 'Уведомлять клиента по SMS при отмене его заказа.',
                    ],

                    'invoice-created' => [
                        'title' => 'Счёт создан',
                        'title-info' => 'Уведомлять клиента по SMS при создании счёта для его заказа.',
                    ],

                    'refund-created' => [
                        'title' => 'Возврат создан',
                        'title-info' => 'Уведомлять клиента по SMS при создании возврата для его заказа.',
                    ],
                ],

                'two-factor' => [
                    'info' => 'Разрешить администраторам использовать SMS как метод двухфакторной аутентификации.',
                    ...
                    'settings' => [
                        ...
                        'title' => 'Настройки',
                        'sms' => 'SMS',
                        'title-info' => 'Включить SMS как доступный метод двухфакторной аутентификации для учётных записей администраторов.',
                    ],
                ],
            ],
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'invoices' => 'Счета',
                'locales' => 'Локали',
                'notification-emails' => 'Уведомления по электронной почте',
                'marketing' => 'Маркетинг',
                'mode' => 'Темный режим',
    ...
    'sms' => [
        ...
        'notifications' => [
            'order-placed' => [
                'default-template' => 'Здравствуйте, {customer_name}! Ваш заказ #{order_id} успешно оформлен. Итого: {order_total}. Спасибо за покупку у нас!',
            ],

            'order-shipped' => [
                'default-template' => 'Здравствуйте, {customer_name}! Ваш заказ #{order_id} отправлен и уже в пути.',
            ],

            'order-cancelled' => [
                'default-template' => 'Здравствуйте, {customer_name}! Ваш заказ #{order_id} отменён.',
            ],

            'invoice-created' => [
                'default-template' => 'Здравствуйте, {customer_name}! Для вашего заказа #{order_id} создан счёт. Итого: {order_total}.',
            ],

            'refund-created' => [
                'default-template' => 'Здравствуйте, {customer_name}! Для вашего заказа #{order_id} оформлен возврат.',
            ],
        ],

        'two-factor' => [
            'otp-message' => 'Ваш код подтверждения: :code. Он истечёт через 5 минут.',
        ],

        'messages' => [
            'delete-success' => 'Журнал SMS успешно удалён.',
        ],
    ],
];
