...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create' => [
                'title' => 'Creează cont',
                'back-btn' => 'Înapoi',
                'save-btn' => 'Salvează cont',
                'general' => 'General',
                'code' => 'Cod',
                'name' => 'Nume',
                'type' => 'Tip',
                'parent' => 'Cont părinte',
                'no-parent' => 'Fără cont părinte',
                'opening-balance' => 'Sold inițial',
                'status' => 'Stare',
            ...
            'create-success' => 'Cont creat cu succes.',
            'update-success' => 'Cont actualizat cu succes.',
            'delete-success' => 'Cont șters cu succes.',
            'system-account-error' => 'Acesta este un cont de sistem protejat și nu poate fi șters.',
            'in-use-error' => 'Acest cont are subconturi sau note contabile și nu poate fi șters.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Note contabile',
                'create-btn' => 'Creează notă contabilă',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Număr notă',
                    'entry-date' => 'Data notei',
                    'reference-type' => 'Referință',
                    'description' => 'Descriere',
                    'total' => 'Total',
                    'status' => 'Stare',
                    'view' => 'Vizualizează',
            ...
            'create' => [
                'title' => 'Creează notă contabilă',
                'back-btn' => 'Înapoi',
                'save-draft-btn' => 'Salvează ca ciornă',
                'save-post-btn' => 'Salvează și înregistrează',
                'general' => 'General',
                'entry-date' => 'Data notei',
                'description' => 'Descriere',
                'lines' => 'Linii',
                'account' => 'Cont',
                'line-description' => 'Descriere',
                'debit' => 'Debit',
                'credit' => 'Credit',
            ...
            'auto-post' => [
                'invoice' => 'Înregistrat automat pentru factura :invoice',
                'payment' => 'Plată înregistrată automat pentru factura :invoice',
                'refund' => 'Înregistrat automat pentru rambursarea #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'Nota contabilă nu este echilibrată. Totalul debit trebuie să fie egal cu totalul credit.',
                'only-draft-can-be-posted' => 'Doar notele contabile în ciornă pot fi înregistrate.',
                'only-posted-can-be-voided' => 'Doar notele contabile înregistrate pot fi anulate.',
            ],
            'create-success' => 'Nota contabilă a fost creată cu succes.',
            'post-success' => 'Nota contabilă a fost înregistrată cu succes.',
            'void-success' => 'Nota contabilă a fost anulată cu succes.',
        ],
        'ledger' => [
            'index' => [
                ...
                'credit' => 'Credit',
                'balance' => 'Sold',
                'no-transactions' => 'Nu s-au găsit tranzacții pentru perioada selectată.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Ani fiscali',
                'create-btn' => 'Creează an fiscal',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Cod',
                    'start-date' => 'Data de început',
            ...
            'create' => [
                'title' => 'Creează an fiscal',
                'back-btn' => 'Înapoi',
                'save-btn' => 'Salvează anul fiscal',
                'code' => 'Cod',
                'code-placeholder' => 'ex. AF2026',
                'start-date' => 'Data de început',
                'end-date' => 'Data de sfârșit',
            ],
            'statuses' => [
            ...
            'create-success' => 'Anul fiscal a fost creat cu succes.',
            'close-success' => 'Anul fiscal a fost închis cu succes.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Setări contabilitate',
                'save-btn' => 'Salvează setările',
                'mapping-title' => 'Maparea implicită a conturilor',
                'mapping-info' => 'Asociați conturile folosite pentru a înregistra automat notele contabile la crearea facturilor, plăților și rambursărilor.',
                'accounts-receivable-account' => 'Cont clienți',
                'cash-bank-account' => 'Cont casă / bancă',
                'sales-revenue-account' => 'Cont venituri din vânzări',
                'shipping-revenue-account' => 'Cont venituri din livrare',
                'sales-discount-account' => 'Cont reduceri comerciale',
                'sales-refund-account' => 'Cont rambursări vânzări',
                'tax-payable-account' => 'Cont taxe de plată',
                'not-mapped' => 'Nemapat',
            ],
            'update-success' => 'Setările de contabilitate au fost actualizate cu succes.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Balanță de verificare',
                'as-of-date' => 'La data de',
                'filter-btn' => 'Filtrează',
                'code' => 'Cod',
                'account' => 'Cont',
                'debit' => 'Debit',
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => 'Rezultatul perioadei',
                'total-liabilities-and-equity' => 'Total datorii și capital propriu',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Configure iyzico payment gateway settings. After saving, set the Callback URL in your iyzico dashboard integration settings to your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Enter your iyzico Secret Key obtained from the iyzico dashboard',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Configure PayTR payment gateway settings. After saving, set the Notification URL in your PayTR merchant panel to your-shop-url/paytr/notify — PayTR requires this to be set manually.',
                    'paytr-merchant-id-info' => 'Enter your PayTR Merchant ID obtained from PayTR panel',
                    'paytr-merchant-key-info' => 'Enter your PayTR Merchant Key obtained from PayTR panel',
                    'paytr-merchant-salt-info' => 'Enter your PayTR Merchant Salt obtained from PayTR panel',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Setări',
                'chart-of-accounts' => 'Plan de conturi',
                'fiscal-years' => 'Ani fiscali',
                'journal-entries' => 'Note contabile',
                'ledger' => 'Registru general',
                'reports' => 'Rapoarte',
    ...
    'acl' => [
        'accounting' => 'Contabilitate',
        'accounting-accounts' => 'Plan de conturi',
        'accounting-close' => 'Închide',
        'accounting-fiscal-years' => 'Ani fiscali',
        'accounting-journal-entries' => 'Note contabile',
        'accounting-ledger' => 'Registru general',
        'accounting-post' => 'Înregistrează',
        'accounting-reports' => 'Rapoarte',
        'accounting-settings' => 'Setări',
        'accounting-void' => 'Anulează',
        'addresses' => 'Addresses',
        'attribute-families' => 'Attribute Families',
        'attributes' => 'Attributes',
        'campaigns' => 'Campaigns',
