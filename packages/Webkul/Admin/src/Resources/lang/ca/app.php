...
return [
    ...
    'accounting' => [
        'accounts' => [
            'index' => [
                'title' => 'Pla de comptes',
                'create-btn' => 'Crear compte',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Codi',
                    'name' => 'Nom',
            ...
            'create-success' => 'Compte creat correctament.',
            'update-success' => 'Compte actualitzat correctament.',
            'delete-success' => 'Compte eliminat correctament.',
            'system-account-error' => 'Aquest és un compte de sistema protegit i no es pot eliminar.',
            'in-use-error' => 'Aquest compte té subcomptes o assentaments i no es pot eliminar.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Assentaments comptables',
                'create-btn' => 'Crear assentament comptable',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Número d\'assentament',
                    'entry-date' => 'Data de l\'assentament',
                    'reference-type' => 'Referència',
                    'description' => 'Descripció',
                    'total' => 'Total',
                    'status' => 'Estat',
                    'view' => 'Veure',
            ...
            'create' => [
                'title' => 'Crear assentament comptable',
                'back-btn' => 'Enrere',
                'save-draft-btn' => 'Desar com a esborrany',
                'save-post-btn' => 'Desar i comptabilitzar',
                'general' => 'General',
                'entry-date' => 'Data de l\'assentament',
                'description' => 'Descripció',
                'lines' => 'Línies',
                'account' => 'Compte',
                'line-description' => 'Descripció',
                'debit' => 'Deure',
                'credit' => 'Haver',
                'select-account' => 'Seleccionar compte',
                'add-line' => 'Afegeix línia',
            ],
            'view' => [
                'back-btn' => 'Enrere',
                'post-btn' => 'Comptabilitzar',
                'void-btn' => 'Anul·lar',
                'entry-date' => 'Data de l\'assentament',
                'status' => 'Estat',
                'reference-type' => 'Referència',
            ...
            'auto-post' => [
                'invoice' => 'Comptabilitzat automàticament per la factura :invoice',
                'payment' => 'Pagament comptabilitzat automàticament per la factura :invoice',
                'refund' => 'Comptabilitzat automàticament pel reemborsament #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'L\'assentament no està quadrat. El total del deure ha de ser igual al total de l\'haver.',
                'only-draft-can-be-posted' => 'Només els assentaments en esborrany es poden comptabilitzar.',
                'only-posted-can-be-voided' => 'Només els assentaments comptabilitzats es poden anul·lar.',
            ],
            'create-success' => 'Assentament comptable creat correctament.',
            'post-success' => 'Assentament comptable comptabilitzat correctament.',
            'void-success' => 'Assentament comptable anul·lat correctament.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Llibre major',
                ...
                'credit' => 'Haver',
                'balance' => 'Saldo',
                'no-transactions' => 'No s\'han trobat transaccions per al període seleccionat.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Anys fiscals',
                'create-btn' => 'Crear any fiscal',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Codi',
                    'start-date' => 'Data d\'inici',
            ...
            'create' => [
                'title' => 'Crear any fiscal',
                'back-btn' => 'Enrere',
                'save-btn' => 'Desar any fiscal',
                'code' => 'Codi',
                'code-placeholder' => 'p. ex. AF2026',
                'start-date' => 'Data d\'inici',
                'end-date' => 'Data de finalització',
            ],
            'statuses' => [
            ...
            'create-success' => 'Any fiscal creat correctament.',
            'close-success' => 'Any fiscal tancat correctament.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Configuració de comptabilitat',
                'save-btn' => 'Desar configuració',
                'mapping-title' => 'Assignació de comptes per defecte',
                'mapping-info' => 'Assigneu els comptes utilitzats per comptabilitzar automàticament assentaments en crear factures, pagaments i reemborsaments.',
                'accounts-receivable-account' => 'Compte a cobrar',
                'cash-bank-account' => 'Compte de caixa / banc',
                'sales-revenue-account' => 'Compte d\'ingressos per vendes',
                'shipping-revenue-account' => 'Compte d\'ingressos per enviament',
                'sales-discount-account' => 'Compte de descomptes de vendes',
                'sales-refund-account' => 'Compte de reemborsaments de vendes',
                'tax-payable-account' => 'Compte d\'impostos a pagar',
                'not-mapped' => 'Sense assignar',
            ],
            'update-success' => 'Configuració de comptabilitat actualitzada correctament.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Balanç de comprovació',
                'as-of-date' => 'A data de',
                'filter-btn' => 'Filtrar',
                'code' => 'Codi',
                'account' => 'Compte',
                'debit' => 'Deure',
            ...
            'income-statement' => [
                ...
                'revenue' => 'Ingressos',
                'expenses' => 'Despeses',
                'total-revenue' => 'Total d\'ingressos',
                'total-expense' => 'Total de despeses',
                'net-income' => 'Resultat net',
            ],
            'balance-sheet' => [
                'title' => 'Balanç general',
                'as-of-date' => 'A data de',
                'filter-btn' => 'Filtrar',
                'assets' => 'Actius',
                'liabilities' => 'Passius',
                'equity' => 'Patrimoni net',
                'total-assets' => 'Total d\'actius',
                'total-liabilities' => 'Total de passius',
                'total-equity' => 'Total del patrimoni net',
                'current-earnings' => 'Resultat del període',
                'total-liabilities-and-equity' => 'Total passiu i patrimoni net',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Configureu els ajustos de la passarel·la de pagament iyzico. Després de desar, establiu l\'URL de retorn a la configuració d\'integració del vostre tauler d\'iyzico com your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Introduïu la vostra clau secreta obtinguda del tauler d\'iyzico',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Configureu els ajustos de la passarel·la de pagament PayTR. Després de desar, establiu l\'URL de notificació al vostre tauler de comerciant de PayTR com your-shop-url/paytr/notify — PayTR requereix que això es configuri manualment.',
                    'paytr-merchant-id-info' => 'Introduïu el vostre ID de comerciant obtingut del panell de PayTR',
                    'paytr-merchant-key-info' => 'Introduïu la vostra clau de comerciant obtinguda del panell de PayTR',
                    'paytr-merchant-salt-info' => 'Introduïu la vostra sal de comerciant obtinguda del panell de PayTR',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Configuració',
                'chart-of-accounts' => 'Pla de comptes',
                'fiscal-years' => 'Anys fiscals',
                'journal-entries' => 'Assentaments comptables',
                'ledger' => 'Llibre major',
                'reports' => 'Informes',
    ...
    'acl' => [
        'accounting' => 'Comptabilitat',
        'accounting-accounts' => 'Pla de comptes',
        'accounting-close' => 'Tancar',
        'accounting-fiscal-years' => 'Anys fiscals',
        'accounting-journal-entries' => 'Assentaments comptables',
        'accounting-ledger' => 'Llibre major',
        'accounting-post' => 'Comptabilitzar',
        'accounting-reports' => 'Informes',
        'accounting-settings' => 'Configuració',
        'accounting-void' => 'Anul·lar',
        'addresses' => 'Adreces',
        'attribute-families' => 'Famílies d\'Atributs',
        'attributes' => 'Atributs',
        'campaigns' => 'Campanyes',
