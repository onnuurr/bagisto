...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'Hesap başarıyla oluşturuldu.',
            'update-success' => 'Hesap başarıyla güncellendi.',
            'delete-success' => 'Hesap başarıyla silindi.',
            'system-account-error' => 'Bu, korumalı bir sistem hesabıdır ve silinemez.',
            'in-use-error' => 'Bu hesabın alt hesapları veya yevmiye kayıtları var, bu nedenle silinemez.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Yevmiye Kayıtları',
                'create-btn' => 'Yevmiye Kaydı Oluştur',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Kayıt Numarası',
                    'entry-date' => 'Kayıt Tarihi',
                    'reference-type' => 'Referans',
                    'description' => 'Açıklama',
                    'total' => 'Toplam',
                    'status' => 'Durum',
                    'view' => 'Görüntüle',
            ...
            'create' => [
                'title' => 'Yevmiye Kaydı Oluştur',
                'back-btn' => 'Geri',
                'save-draft-btn' => 'Taslak Olarak Kaydet',
                'save-post-btn' => 'Kaydet ve İşle',
                'general' => 'Genel',
                'entry-date' => 'Kayıt Tarihi',
                'description' => 'Açıklama',
                'lines' => 'Satırlar',
                'account' => 'Hesap',
                'line-description' => 'Açıklama',
                'debit' => 'Borç',
                'credit' => 'Alacak',
            ...
            'auto-post' => [
                'invoice' => ':invoice faturası için otomatik kaydedildi',
                'payment' => ':invoice faturası için ödeme otomatik kaydedildi',
                'refund' => '#:refund iadesi için otomatik kaydedildi',
            ],
            'errors' => [
                'unbalanced-entry' => 'Yevmiye kaydı dengeli değil. Toplam borç, toplam alacağa eşit olmalıdır.',
                'only-draft-can-be-posted' => 'Yalnızca taslak yevmiye kayıtları kaydedilebilir.',
                'only-posted-can-be-voided' => 'Yalnızca kaydedilmiş yevmiye kayıtları iptal edilebilir.',
            ],
            'create-success' => 'Yevmiye kaydı başarıyla oluşturuldu.',
            'post-success' => 'Yevmiye kaydı başarıyla kaydedildi.',
            'void-success' => 'Yevmiye kaydı başarıyla iptal edildi.',
        ],
        'ledger' => [
            'index' => [
                ...
                'credit' => 'Alacak',
                'balance' => 'Bakiye',
                'no-transactions' => 'Seçilen dönem için işlem bulunamadı.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Mali Yıllar',
                'create-btn' => 'Mali Yıl Oluştur',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Kod',
                    'start-date' => 'Başlangıç Tarihi',
            ...
            'create' => [
                'title' => 'Mali Yıl Oluştur',
                'back-btn' => 'Geri',
                'save-btn' => 'Mali Yılı Kaydet',
                'code' => 'Kod',
                'code-placeholder' => 'örn. MY2026',
                'start-date' => 'Başlangıç Tarihi',
                'end-date' => 'Bitiş Tarihi',
            ],
            'statuses' => [
            ...
            'create-success' => 'Mali yıl başarıyla oluşturuldu.',
            'close-success' => 'Mali yıl başarıyla kapatıldı.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Muhasebe Ayarları',
                'save-btn' => 'Ayarları Kaydet',
                'mapping-title' => 'Varsayılan Hesap Eşleştirmesi',
                'mapping-info' => 'Fatura, ödeme ve iade oluşturulduğunda yevmiye kayıtlarının otomatik olarak işleneceği hesapları eşleştirin.',
                'accounts-receivable-account' => 'Alacak Hesapları',
                'cash-bank-account' => 'Kasa / Banka Hesabı',
                'sales-revenue-account' => 'Satış Geliri Hesabı',
                'shipping-revenue-account' => 'Kargo Geliri Hesabı',
                'sales-discount-account' => 'Satış İskontosu Hesabı',
                'sales-refund-account' => 'Satış İade Hesabı',
                'tax-payable-account' => 'Ödenecek Vergi Hesabı',
                'not-mapped' => 'Eşleştirilmedi',
            ],
            'update-success' => 'Muhasebe ayarları başarıyla güncellendi.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Mizan',
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => 'Dönem Kârı',
                'total-liabilities-and-equity' => 'Toplam Borç ve Özkaynak',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'iyzico ödeme ağ geçidi ayarlarını yapılandırın. Kaydettikten sonra iyzico panelinizdeki entegrasyon ayarlarında Geri Bildirim URL\'sini magaza-adresiniz/iyzico/callback olarak ayarlayın.',
                    'iyzico-secret-key-info' => 'iyzico panelinden aldığınız Gizli Anahtarınızı girin',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'PayTR ödeme ağ geçidi ayarlarını yapılandırın. Kaydettikten sonra PayTR mağaza panelinizden Bildirim URL adresini magaza-adresiniz/paytr/notify olarak ayarlayın — PayTR bunun elle ayarlanmasını gerektirir.',
                    'paytr-merchant-id-info' => 'PayTR panelinden aldığınız Mağaza Numaranızı girin',
                    'paytr-merchant-key-info' => 'PayTR panelinden aldığınız Mağaza Anahtarınızı girin',
                    'paytr-merchant-salt-info' => 'PayTR panelinden aldığınız Mağaza Salt bilginizi girin',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                'accounting' => 'Muhasebe',
                'accounting-settings' => 'Ayarlar',
                'chart-of-accounts' => 'Hesap Planı',
                'fiscal-years' => 'Mali Yıllar',
    ...
    'acl' => [
        ...
        'accounting-close' => 'Kapat',
        'accounting-fiscal-years' => 'Mali Yıllar',
        'accounting-journal-entries' => 'Yevmiye Kayıtları',
        'accounting-ledger' => 'Defter-i Kebir',
        'accounting-post' => 'Kaydet',
        'accounting-reports' => 'Raporlar',
        'accounting-settings' => 'Ayarlar',
        'accounting-void' => 'İptal Et',
        'addresses' => 'Adresler',
        'attribute-families' => 'Özellik Aileleri',
        'attributes' => 'Özellikler',
        'campaigns' => 'Kampanyalar',
