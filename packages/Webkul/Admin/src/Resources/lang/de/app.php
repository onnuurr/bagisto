...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'Konto erfolgreich erstellt.',
            'update-success' => 'Konto erfolgreich aktualisiert.',
            'delete-success' => 'Konto erfolgreich gelöscht.',
            'system-account-error' => 'Dies ist ein geschütztes Systemkonto und kann nicht gelöscht werden.',
            'in-use-error' => 'Dieses Konto hat untergeordnete Konten oder Buchungen und kann nicht gelöscht werden.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Buchungssätze',
                'create-btn' => 'Buchungssatz erstellen',
                'datagrid' => [
                    'id' => 'ID',
            ...
            'create' => [
                'title' => 'Buchungssatz erstellen',
                'back-btn' => 'Zurück',
                'save-draft-btn' => 'Als Entwurf speichern',
                'save-post-btn' => 'Speichern & Buchen',
                'general' => 'Allgemein',
                'entry-date' => 'Buchungsdatum',
                'description' => 'Beschreibung',
                'lines' => 'Buchungszeilen',
                'account' => 'Konto',
                'line-description' => 'Beschreibung',
                'debit' => 'Soll',
                'credit' => 'Haben',
            ...
            'auto-post' => [
                'invoice' => 'Automatisch gebucht für Rechnung :invoice',
                'payment' => 'Zahlung automatisch gebucht für Rechnung :invoice',
                'refund' => 'Automatisch gebucht für Rückerstattung #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'Der Buchungssatz ist nicht ausgeglichen. Die Summe von Soll und Haben muss übereinstimmen.',
                'only-draft-can-be-posted' => 'Nur Buchungssätze im Entwurf können gebucht werden.',
                'only-posted-can-be-voided' => 'Nur gebuchte Buchungssätze können storniert werden.',
            ],
            'create-success' => 'Buchungssatz erfolgreich erstellt.',
            'post-success' => 'Buchungssatz erfolgreich gebucht.',
            'void-success' => 'Buchungssatz erfolgreich storniert.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Hauptbuch',
                ...
                'credit' => 'Haben',
                'balance' => 'Saldo',
                'no-transactions' => 'Für den ausgewählten Zeitraum wurden keine Buchungen gefunden.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Geschäftsjahre',
                'create-btn' => 'Geschäftsjahr erstellen',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Code',
                    'start-date' => 'Startdatum',
            ...
            'create' => [
                'title' => 'Geschäftsjahr erstellen',
                'back-btn' => 'Zurück',
                'save-btn' => 'Geschäftsjahr speichern',
                'code' => 'Code',
                'code-placeholder' => 'z. B. GJ2026',
                'start-date' => 'Startdatum',
                'end-date' => 'Enddatum',
            ],
            'statuses' => [
            ...
            'create-success' => 'Geschäftsjahr erfolgreich erstellt.',
            'close-success' => 'Geschäftsjahr erfolgreich geschlossen.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Buchhaltungseinstellungen',
                'save-btn' => 'Einstellungen speichern',
                'mapping-title' => 'Standard-Kontenzuordnung',
                'mapping-info' => 'Ordnen Sie die Konten zu, die für automatische Buchungen bei Rechnungen, Zahlungen und Rückerstattungen verwendet werden.',
                'accounts-receivable-account' => 'Forderungskonto',
                'cash-bank-account' => 'Kassen-/Bankkonto',
                'sales-revenue-account' => 'Umsatzerlöskonto',
                'shipping-revenue-account' => 'Versanderlöskonto',
                'sales-discount-account' => 'Verkaufsrabattkonto',
                'sales-refund-account' => 'Verkaufsrückerstattungskonto',
                'tax-payable-account' => 'Umsatzsteuerverbindlichkeitskonto',
                'not-mapped' => 'Nicht zugeordnet',
            ],
            'update-success' => 'Buchhaltungseinstellungen erfolgreich aktualisiert.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Summen- und Saldenliste',
                'as-of-date' => 'Stand vom',
                'filter-btn' => 'Filtern',
                'code' => 'Code',
                'account' => 'Konto',
                'debit' => 'Soll',
            ...
            'income-statement' => [
                ...
                'total-expense' => 'Gesamtaufwand',
                'net-income' => 'Reingewinn',
            ],
            'balance-sheet' => [
                'title' => 'Bilanz',
                'as-of-date' => 'Stand vom',
                ...
                'current-earnings' => 'Laufender Gewinn',
                'total-liabilities-and-equity' => 'Verbindlichkeiten & Eigenkapital gesamt',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Konfigurieren Sie die iyzico-Zahlungsgateway-Einstellungen. Setzen Sie nach dem Speichern die Callback-URL in Ihren iyzico-Dashboard-Integrationseinstellungen auf your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Geben Sie Ihren geheimen Schlüssel aus dem iyzico-Dashboard ein',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Konfigurieren Sie die PayTR-Zahlungsgateway-Einstellungen. Setzen Sie nach dem Speichern die Benachrichtigungs-URL in Ihrem PayTR-Händlerpanel auf your-shop-url/paytr/notify — PayTR erfordert, dass dies manuell eingestellt wird.',
                    'paytr-merchant-id-info' => 'Geben Sie Ihre PayTR Merchant-ID aus dem PayTR-Panel ein',
                    'paytr-merchant-key-info' => 'Geben Sie Ihren PayTR Merchant-Key aus dem PayTR-Panel ein',
                    'paytr-merchant-salt-info' => 'Geben Sie Ihr PayTR Merchant-Salt aus dem PayTR-Panel ein',
                    'payu' => 'PayU',
