...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create' => [
                ...
                'back-btn' => 'Назад',
                'save-btn' => 'Зберегти рахунок',
                'general' => 'Загальне',
                'code' => 'Код',
                'name' => 'Назва',
                'type' => 'Тип',
                'parent' => 'Батьківський рахунок',
                'no-parent' => 'Без батьківського рахунку',
                'opening-balance' => 'Початкове сальдо',
                'status' => 'Статус',
                'description' => 'Опис',
            ],
            ...
            'create-success' => 'Рахунок успішно створено.',
            'update-success' => 'Рахунок успішно оновлено.',
            'delete-success' => 'Рахунок успішно видалено.',
            'system-account-error' => 'Це захищений системний рахунок, його не можна видалити.',
            'in-use-error' => 'Цей рахунок має дочірні рахунки або проведення, тому його не можна видалити.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Проведення',
                'create-btn' => 'Створити проведення',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Номер проведення',
                    'entry-date' => 'Дата проведення',
                    'reference-type' => 'Посилання',
                    'description' => 'Опис',
                    'total' => 'Разом',
                    'status' => 'Статус',
                    'view' => 'Перегляд',
            ...
            'create' => [
                'title' => 'Створити проведення',
                'back-btn' => 'Назад',
                'save-draft-btn' => 'Зберегти як чернетку',
                'save-post-btn' => 'Зберегти і провести',
                'general' => 'Загальне',
                'entry-date' => 'Дата проведення',
                'description' => 'Опис',
                'lines' => 'Рядки',
                'account' => 'Рахунок',
                'line-description' => 'Опис',
                'debit' => 'Дебет',
                'credit' => 'Кредит',
            ...
            'auto-post' => [
                'invoice' => 'Автоматично проведено для рахунку :invoice',
                'payment' => 'Платіж автоматично проведено для рахунку :invoice',
                'refund' => 'Автоматично проведено для повернення #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'Проведення незбалансоване. Сума дебету має дорівнювати сумі кредиту.',
                'only-draft-can-be-posted' => 'Провести можна лише проведення у статусі чернетки.',
                'only-posted-can-be-voided' => 'Анулювати можна лише проведені записи.',
            ],
            'create-success' => 'Проведення успішно створено.',
            'post-success' => 'Проведення успішно виконано.',
            'void-success' => 'Проведення успішно анульовано.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Головна книга',
                ...
                'credit' => 'Кредит',
                'balance' => 'Баланс',
                'no-transactions' => 'За обраний період транзакцій не знайдено.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Фінансові роки',
                'create-btn' => 'Створити фінансовий рік',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Код',
                    'start-date' => 'Дата початку',
            ...
            'create' => [
                'title' => 'Створити фінансовий рік',
                'back-btn' => 'Назад',
                'save-btn' => 'Зберегти фінансовий рік',
                'code' => 'Код',
                'code-placeholder' => 'напр. ФР2026',
                'start-date' => 'Дата початку',
                'end-date' => 'Дата закінчення',
            ],
            'statuses' => [
            ...
            'create-success' => 'Фінансовий рік успішно створено.',
            'close-success' => 'Фінансовий рік успішно закрито.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Налаштування бухгалтерії',
                'save-btn' => 'Зберегти налаштування',
                'mapping-title' => 'Зіставлення рахунків за замовчуванням',
                'mapping-info' => 'Зіставте рахунки, що використовуються для автоматичного проведення записів під час створення рахунків, платежів і повернень.',
                'accounts-receivable-account' => 'Рахунок дебіторської заборгованості',
                'cash-bank-account' => 'Каса / банківський рахунок',
                'sales-revenue-account' => 'Рахунок доходу від продажів',
                'shipping-revenue-account' => 'Рахунок доходу від доставки',
                'sales-discount-account' => 'Рахунок знижок з продажів',
                'sales-refund-account' => 'Рахунок повернень з продажів',
                'tax-payable-account' => 'Рахунок податків до сплати',
                'not-mapped' => 'Не зіставлено',
            ],
            'update-success' => 'Налаштування бухгалтерії успішно оновлено.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'Оборотно-сальдова відомість',
                'as-of-date' => 'Станом на',
                'filter-btn' => 'Фільтр',
                'code' => 'Код',
                'account' => 'Рахунок',
                'debit' => 'Дебет',
            ...
            'income-statement' => [
                ...
                'revenue' => 'Дохід',
                'expenses' => 'Витрати',
                'total-revenue' => 'Разом дохід',
                'total-expense' => 'Разом витрати',
                'net-income' => 'Чистий прибуток',
            ],
            'balance-sheet' => [
                'title' => 'Бухгалтерський баланс',
                'as-of-date' => 'Станом на',
                'filter-btn' => 'Фільтр',
                'assets' => 'Активи',
                'liabilities' => 'Зобов’язання',
                'equity' => 'Власний капітал',
                'total-assets' => 'Разом активи',
                'total-liabilities' => 'Разом зобов’язання',
                'total-equity' => 'Разом власний капітал',
                'current-earnings' => 'Прибуток за період',
                'total-liabilities-and-equity' => 'Разом зобов’язання і капітал',
            ],
        ],
    ],
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Налаштування',
                'chart-of-accounts' => 'План рахунків',
                'fiscal-years' => 'Фінансові роки',
                'journal-entries' => 'Проведення',
    ...
    'acl' => [
        'accounting' => 'Бухгалтерія',
        'accounting-accounts' => 'План рахунків',
        'accounting-close' => 'Закрити',
        'accounting-fiscal-years' => 'Фінансові роки',
        'accounting-journal-entries' => 'Проведення',
        'accounting-ledger' => 'Головна книга',
        'accounting-post' => 'Провести',
        'accounting-reports' => 'Звіти',
        'accounting-settings' => 'Налаштування',
        'accounting-void' => 'Анулювати',
        'addresses' => 'Адреси',
        'attribute-families' => 'Сімейства атрибутів',
        'attributes' => 'Атрибути',
        'campaigns' => 'Кампанії',
