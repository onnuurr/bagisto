            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    ...
                    'aras-kargo' => [
                        ...
                        'status' => 'Статус',
                        'title' => 'Назва',
                        'title-info' => 'Розраховує вартість доставки через API Aras Kargo з використанням облікових даних вашого акаунта та повертається до фіксованого тарифу, якщо API недоступний.',
                        'username' => 'Ім\'я користувача',
                        'wsdl-url' => 'URL-адреса WSDL',
                        'rate' => 'Ставка',
                    ],

                    'kargonomi' => [
                        'api-token' => 'Токен API',
                        'app-key' => 'Ключ додатка',
                        'description' => 'Опис',
                        'page-title' => 'Kargonomi',
                        'shipping-provider-id' => 'ID бажаного перевізника',
                        'status' => 'Статус',
                        'title' => 'Назва',
                        'title-info' => 'Розраховує актуальний тариф доставки через порівняння кількох перевізників Kargonomi, створюючи чернетку відправлення для кошика та зчитуючи його розцінку, і повертається до фіксованого тарифу, якщо API недоступний.',
                        'warehouse-id' => 'ID складу',
                        'rate' => 'Ставка',
                    ],
                ],
