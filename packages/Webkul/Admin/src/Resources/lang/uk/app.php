...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'code-sent' => 'Надіслано новий код підтвердження.',
    ...
    'account' => [
        'edit' => [
            ...
            'method-authenticator' => 'Додаток-автентифікатор',
            'method-sms' => 'SMS',
            'phone' => 'Номер телефону',
            'send-code' => 'Надіслати код',
            'two-factor-method' => 'Метод двофакторної автентифікації',
        ],
        ...
        'messages' => [
            ...
            'code-sent-success' => 'Код підтвердження успішно надіслано.',
            'phone-required' => 'Додайте номер телефону перед увімкненням SMS-підтвердження.',
        ],
    ...
    'catalog' => [
        ...
        'product-tags' => [
            'index' => [
                'add-btn' => 'Створити тег товару',
                'title' => 'Теги товарів',

                'datagrid' => [
                    'delete' => 'Видалити',
                    'delete-failed' => 'Під час видалення тегу товару сталася помилка',
                    'delete-success' => 'Тег товару успішно видалено.',
                    'edit' => 'Редагувати',
                    'id' => 'ID',
                    'image' => 'Зображення',
                    'mass-delete-success' => 'Вибрані теги товарів успішно видалено',
                    'name' => 'Назва',
                ],
            ],
            ...
            'create' => [
                'back-btn' => 'Назад',
                'create-success' => 'Тег товару успішно створено.',
                'general' => 'Загальні',
                'image' => 'Зображення',
                'image-info' => 'Якщо зображення доступне, воно буде показане на товарі, інакше назва буде показана як текстовий значок.',
                'name' => 'Назва',
                'save-btn' => 'Зберегти тег товару',
                'title' => 'Додати новий тег товару',
            ],
            ...
            'edit' => [
                ...
                'name' => 'Назва',
                'save-btn' => 'Зберегти тег товару',
                'title' => 'Редагувати тег товару',
                'update-success' => 'Тег товару успішно оновлено.',
            ],
        ],
    ...
    'marketing' => [
        ...
        'promotions' => [
            'index' => [
                ...
                'gift-card-title' => 'Подарункові картки',
            ],
            ...
            'gift-cards' => [
                'index' => [
                    'create-btn' => 'Створити подарункову картку',
                    ...
                    'datagrid' => [
                        ...
                        'expires-at' => 'Дійсна до',
                        'id' => 'ID',
                        'mass-delete-success' => 'Вибрані подарункові картки успішно видалено',
                        'status' => 'Статус',
                        'unused' => 'Не використана',
                        'used' => 'Використана',
                        'used-at' => 'Дата використання',
                    ],
                ],
                ...
                'create' => [
                    'amount' => 'Сума',
                    'code' => 'Код',
                    'code-info' => 'Залиште порожнім для автоматичної генерації.',
                    'currency' => 'Валюта',
                    'customer-email' => 'Email клієнта',
                    'expires-at' => 'Дійсна до',
                    'quantity' => 'Кількість',
                    'quantity-info' => 'Кількість подарункових карток для генерації. Якщо кількість більша за 1, код ігнорується та генерується автоматично.',
                    'save-btn' => 'Зберегти подарункову картку',
                    'success' => 'Подарункову картку успішно створено',
                ...
                'edit' => [
                    ...
                    'expires-at' => 'Дійсна до',
                    'status' => 'Статус',
                    'success' => 'Подарункову картку успішно оновлено',
                    'title' => 'Редагувати подарункову картку',
                    'unused' => 'Не використана',
                    'used' => 'Використана',
                ],

                'delete-failed' => 'Подарункову картку неможливо видалити, оскільки її вже використано',
                'delete-success' => 'Подарункову картку успішно видалено',
            ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Налаштуйте параметри платіжного шлюзу iyzico. Після збереження встановіть URL зворотного виклику в налаштуваннях інтеграції панелі iyzico на your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Введіть свій секретний ключ, отриманий на панелі iyzico',
                    'local-payment' => 'Локальний платіж',
                    'local-payment-info' => 'Локальний ручний спосіб оплати — шаблон, який можна налаштувати за потреби.',
                    'logo' => 'Логотип',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Налаштуйте параметри платіжного шлюзу PayTR. Після збереження встановіть URL сповіщень у панелі продавця PayTR на your-shop-url/paytr/notify — PayTR вимагає встановити це вручну.',
                    'paytr-merchant-id-info' => 'Введіть свій Merchant ID, отриманий на панелі PayTR',
                    'paytr-merchant-key-info' => 'Введіть свій Merchant Key, отриманий на панелі PayTR',
                    'paytr-merchant-salt-info' => 'Введіть свій Merchant Salt, отриманий на панелі PayTR',
                    'payu' => 'PayU',
            ...
            'sms' => [
                'info' => 'Налаштуйте SMS-шлюзи, сповіщення про замовлення та двофакторну автентифікацію через SMS.',
                'title' => 'SMS',

                'general' => [
                    'info' => 'Загальні налаштування SMS.',
                    'title' => 'Загальні',

                    'settings' => [
                        'active-gateway' => 'Активний шлюз',
                        'enabled' => 'Увімкнено',
                        'title' => 'Налаштування',
                        'title-info' => 'Увімкніть або вимкніть SMS-сповіщення для всього застосунку.',
                    ],
                ],

                'gateways' => [
                    'credential-id' => 'SID акаунта / Ключ API',
                    'credential-secret' => 'Auth Token / Секрет API',
                    'info' => 'Налаштуйте облікові дані вашого постачальника SMS-шлюзу.',
                    'sender' => 'Номер відправника / ID відправника',
                    'title' => 'Шлюзи',

                    'twilio' => [
                        'title' => 'Twilio',
                        'title-info' => 'Налаштуйте облікові дані API Twilio.',
                    ],

                    'vonage' => [
                        'title' => 'Vonage',
                        'title-info' => 'Налаштуйте облікові дані API Vonage (Nexmo).',
                    ],
                ...
                'notifications' => [
                    'enabled-label' => 'Увімкнено',
                    'info' => 'Увімкніть SMS-сповіщення для подій замовлення та налаштуйте шаблони повідомлень.',
                    'template-label' => 'Шаблон повідомлення',
                    'title' => 'Сповіщення про замовлення',

                    'order-placed' => [
                        'title' => 'Замовлення оформлено',
                        'title-info' => 'Сповіщати клієнта по SMS, коли оформлено замовлення.',
                    ],

                    'order-shipped' => [
                        'title' => 'Замовлення відправлено',
                        'title-info' => 'Сповіщати клієнта по SMS, коли його замовлення відправлено.',
                    ],

                    'order-cancelled' => [
                        'title' => 'Замовлення скасовано',
                        'title-info' => 'Сповіщати клієнта по SMS, коли його замовлення скасовано.',
                    ],

                    'invoice-created' => [
                        'title' => 'Рахунок створено',
                        'title-info' => 'Сповіщати клієнта по SMS, коли для його замовлення створено рахунок.',
                    ],

                    'refund-created' => [
                        'title' => 'Повернення створено',
                        'title-info' => 'Сповіщати клієнта по SMS, коли для його замовлення створено повернення.',
                    ],
                ],

                'two-factor' => [
                    'info' => 'Дозволити адміністраторам використовувати SMS як метод двофакторної автентифікації.',
                    ...
                    'settings' => [
                        ...
                        'title' => 'Налаштування',
                        'sms' => 'SMS',
                        'title-info' => 'Увімкнути SMS як доступний метод двофакторної автентифікації для облікових записів адміністраторів.',
                    ],
                ],
            ],
        ],
    ...
    'sms' => [
        ...
        'notifications' => [
            'order-placed' => [
                'default-template' => 'Вітаємо, {customer_name}! Ваше замовлення #{order_id} успішно оформлено. Разом: {order_total}. Дякуємо за покупку!',
            ],

            'order-shipped' => [
                'default-template' => 'Вітаємо, {customer_name}! Ваше замовлення #{order_id} відправлено і вже в дорозі.',
            ],

            'order-cancelled' => [
                'default-template' => 'Вітаємо, {customer_name}! Ваше замовлення #{order_id} скасовано.',
            ],

            'invoice-created' => [
                'default-template' => 'Вітаємо, {customer_name}! Для вашого замовлення #{order_id} створено рахунок. Разом: {order_total}.',
            ],

            'refund-created' => [
                'default-template' => 'Вітаємо, {customer_name}! Для вашого замовлення #{order_id} оформлено повернення.',
            ],
        ],

        'two-factor' => [
            'otp-message' => 'Ваш код підтвердження: :code. Він закінчиться через 5 хвилин.',
        ],

        'messages' => [
            'delete-success' => 'Журнал SMS успішно видалено.',
        ],
    ],
];
