            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    ...
                    'kargonomi' => [
                        ...
                        'shipping-provider-id' => 'شناسه شرکت حمل ترجیحی',
                        'status' => 'وضعیت',
                        'title' => 'عنوان',
                        'title-info' => 'با ایجاد یک مرسوله پیش‌نویس برای سبد خرید و خواندن پیشنهاد قیمت آن، نرخ ارسال زنده‌ای را از طریق مقایسه نرخ چند-حامل Kargonomi محاسبه می‌کند و در صورت در دسترس نبودن API از نرخ ثابت جایگزین استفاده می‌کند.',
