...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'code-sent' => 'کد تأیید جدیدی ارسال شد.',
    ...
    'account' => [
        'edit' => [
            ...
            'method-authenticator' => 'برنامه احراز هویت',
            'method-sms' => 'پیامک',
            'phone' => 'شماره تلفن',
            'send-code' => 'ارسال کد',
            'two-factor-method' => 'روش تأیید دو مرحله‌ای',
        ],
        ...
        'messages' => [
            ...
            'code-sent-success' => 'کد تأیید با موفقیت ارسال شد.',
            'phone-required' => 'لطفاً قبل از فعال‌سازی تأیید پیامکی، یک شماره تلفن اضافه کنید.',
        ],
    ...
    'catalog' => [
        ...
        'product-tags' => [
            'index' => [
                'add-btn' => 'ایجاد برچسب محصول',
                'title' => 'برچسب‌های محصول',

                'datagrid' => [
                    'delete' => 'حذف',
                    'delete-failed' => 'خطایی در حذف برچسب محصول رخ داد',
                    'delete-success' => 'برچسب محصول با موفقیت حذف شد.',
                    'edit' => 'ویرایش',
                    'id' => 'شناسه',
                    'image' => 'تصویر',
                    'mass-delete-success' => 'برچسب‌های محصول انتخاب‌شده با موفقیت حذف شدند',
                    'name' => 'نام',
                ],
            ],
            ...
            'create' => [
                'back-btn' => 'بازگشت',
                'create-success' => 'برچسب محصول با موفقیت ایجاد شد.',
                'general' => 'عمومی',
                'image' => 'تصویر',
                'image-info' => 'در صورت وجود تصویر، تصویر روی محصول نمایش داده می‌شود، در غیر این صورت نام به‌صورت یک نشان متنی نمایش داده می‌شود.',
                'name' => 'نام',
                'save-btn' => 'ذخیره برچسب محصول',
                'title' => 'افزودن برچسب محصول جدید',
            ],
            ...
            'edit' => [
                ...
                'name' => 'نام',
                'save-btn' => 'ذخیره برچسب محصول',
                'title' => 'ویرایش برچسب محصول',
                'update-success' => 'برچسب محصول با موفقیت به‌روزرسانی شد.',
            ],
        ],
            ...
            'gift-cards' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'id' => 'شناسه',
                        'mass-delete-success' => 'کارت‌های هدیه انتخاب شده با موفقیت حذف شدند',
                        'status' => 'وضعیت',
                        'unused' => 'استفاده نشده',
                        'used' => 'استفاده شده',
                        'used-at' => 'تاریخ استفاده',
                    ],
                ],
                ...
                'create' => [
                    'amount' => 'مبلغ',
                    'code' => 'کد',
                    'code-info' => 'برای تولید خودکار خالی بگذارید.',
                    'currency' => 'واحد پول',
                    'customer-email' => 'ایمیل مشتری',
                    'expires-at' => 'تاریخ انقضا',
                    'quantity' => 'تعداد',
                    'quantity-info' => 'تعداد کارت‌های هدیه برای تولید. اگر تعداد بیشتر از ۱ باشد، کد نادیده گرفته شده و به‌طور خودکار تولید می‌شود.',
                    'save-btn' => 'ذخیره کارت هدیه',
                    'success' => 'کارت هدیه با موفقیت ایجاد شد',
                ...
                'edit' => [
                    ...
                    'expires-at' => 'تاریخ انقضا',
                    'status' => 'وضعیت',
                    'success' => 'کارت هدیه با موفقیت به‌روزرسانی شد',
                    'title' => 'ویرایش کارت هدیه',
                    'unused' => 'استفاده نشده',
                    'used' => 'استفاده شده',
                ],

                'delete-failed' => 'کارت هدیه قابل حذف نیست زیرا قبلاً استفاده شده است',
                'delete-success' => 'کارت هدیه با موفقیت حذف شد',
            ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'تنظیمات درگاه پرداخت iyzico را پیکربندی کنید. پس از ذخیره، آدرس بازگشت را در تنظیمات یکپارچه‌سازی داشبورد iyzico خود به your-shop-url/iyzico/callback تنظیم کنید.',
                    'iyzico-secret-key-info' => 'کلید مخفی خود را از داشبورد iyzico وارد کنید',
                    'local-payment' => 'پرداخت محلی',
                    'local-payment-info' => 'یک روش پرداخت دستی محلی که در صورت نیاز می‌توانید آن را سفارشی کنید.',
                    'logo' => 'لوگو',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'تنظیمات درگاه پرداخت PayTR را پیکربندی کنید. پس از ذخیره، آدرس اعلان را در پنل فروشنده PayTR خود به your-shop-url/paytr/notify تنظیم کنید — PayTR این مورد را باید به‌صورت دستی تنظیم شود.',
                    'paytr-merchant-id-info' => 'شناسه فروشنده خود را از پنل PayTR وارد کنید',
                    'paytr-merchant-key-info' => 'کلید فروشنده خود را از پنل PayTR وارد کنید',
                    'paytr-merchant-salt-info' => 'نمک فروشنده خود را از پنل PayTR وارد کنید',
                    'payu' => 'پی یو مانی',
            ...
            'sms' => [
                'info' => 'درگاه‌های پیامک، اعلان‌های سفارش و تأیید دو مرحله‌ای مبتنی بر پیامک را پیکربندی کنید.',
                'title' => 'پیامک',

                'general' => [
                    'info' => 'تنظیمات عمومی پیامک.',
                    'title' => 'عمومی',

                    'settings' => [
                        'active-gateway' => 'درگاه فعال',
                        'enabled' => 'فعال',
                        'title' => 'تنظیمات',
                        'title-info' => 'اعلان‌های پیامکی را در سراسر برنامه خود فعال یا غیرفعال کنید.',
                    ],
                ],

                'gateways' => [
                    'credential-id' => 'شناسه حساب (SID) / کلید API',
                    'credential-secret' => 'توکن احراز هویت / رمز API',
                    'info' => 'اطلاعات ورود ارائه‌دهنده درگاه پیامک خود را پیکربندی کنید.',
                    'sender' => 'شماره فرستنده / شناسه فرستنده',
                    'title' => 'درگاه‌ها',

                    'twilio' => [
                        'title' => 'Twilio',
                        'title-info' => 'اطلاعات ورود API توییلیو (Twilio) خود را پیکربندی کنید.',
                    ],

                    'vonage' => [
                        'title' => 'Vonage',
                        'title-info' => 'اطلاعات ورود API ونیج (Vonage/Nexmo) خود را پیکربندی کنید.',
                    ],
                ...
                'notifications' => [
                    'enabled-label' => 'فعال',
                    'info' => 'اعلان‌های پیامکی را برای رویدادهای سفارش فعال کرده و قالب پیام‌های آن‌ها را سفارشی کنید.',
                    'template-label' => 'قالب پیام',
                    'title' => 'اعلان‌های سفارش',

                    'order-placed' => [
                        'title' => 'سفارش ثبت شد',
                        'title-info' => 'هنگام ثبت سفارش، مشتری را از طریق پیامک مطلع کنید.',
                    ],

                    'order-shipped' => [
                        'title' => 'سفارش ارسال شد',
                        'title-info' => 'هنگام ارسال سفارش، مشتری را از طریق پیامک مطلع کنید.',
                    ],

                    'order-cancelled' => [
                        'title' => 'سفارش لغو شد',
                        'title-info' => 'هنگام لغو سفارش، مشتری را از طریق پیامک مطلع کنید.',
                    ],

                    'invoice-created' => [
                        'title' => 'فاکتور ایجاد شد',
                        'title-info' => 'هنگام ایجاد فاکتور برای سفارش، مشتری را از طریق پیامک مطلع کنید.',
                    ],

                    'refund-created' => [
                        'title' => 'استرداد وجه ایجاد شد',
                        'title-info' => 'هنگام ایجاد استرداد وجه برای سفارش، مشتری را از طریق پیامک مطلع کنید.',
                    ],
                ],

                'two-factor' => [
                    'info' => 'به مدیران اجازه دهید از پیامک به‌عنوان روش تأیید دو مرحله‌ای استفاده کنند.',
                    ...
                    'settings' => [
                        ...
                        'title' => 'تنظیمات',
                        'sms' => 'پیامک',
                        'title-info' => 'پیامک را به‌عنوان روش تأیید دو مرحله‌ای در دسترس برای حساب‌های مدیریتی فعال کنید.',
                    ],
                ],
            ],
        ],
    ...
    'sms' => [
        ...
        'notifications' => [
            'order-placed' => [
                'default-template' => 'سلام {customer_name}، سفارش شما #{order_id} با موفقیت ثبت شد. مجموع: {order_total}. از خرید شما متشکریم!',
            ],

            'order-shipped' => [
                'default-template' => 'سلام {customer_name}، سفارش شما #{order_id} ارسال شد و در راه است.',
            ],

            'order-cancelled' => [
                'default-template' => 'سلام {customer_name}، سفارش شما #{order_id} لغو شد.',
            ],

            'invoice-created' => [
                'default-template' => 'سلام {customer_name}، برای سفارش شما #{order_id} فاکتوری صادر شد. مجموع: {order_total}.',
            ],

            'refund-created' => [
                'default-template' => 'سلام {customer_name}، استرداد وجه سفارش شما #{order_id} پردازش شد.',
            ],
        ],

        'two-factor' => [
            'otp-message' => 'کد تأیید شما :code است. این کد ظرف 5 دقیقه منقضی می‌شود.',
        ],

        'messages' => [
            'delete-success' => 'گزارش پیامک با موفقیت حذف شد.',
        ],
    ],
];
