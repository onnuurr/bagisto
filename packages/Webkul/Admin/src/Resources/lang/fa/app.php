...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'حساب با موفقیت ایجاد شد.',
            'update-success' => 'حساب با موفقیت به‌روزرسانی شد.',
            'delete-success' => 'حساب با موفقیت حذف شد.',
            'system-account-error' => 'این یک حساب سیستمی محافظت‌شده است و قابل حذف نیست.',
            'in-use-error' => 'این حساب دارای زیرحساب یا سند حسابداری است و قابل حذف نیست.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'اسناد حسابداری',
                'create-btn' => 'ایجاد سند حسابداری',
                'datagrid' => [
                    'id' => 'شناسه',
                    'entry-number' => 'شماره سند',
                    'entry-date' => 'تاریخ سند',
                    'reference-type' => 'مرجع',
                    'description' => 'توضیحات',
                    'total' => 'جمع کل',
                    'status' => 'وضعیت',
            ...
            'create' => [
                ...
                'back-btn' => 'بازگشت',
                'save-draft-btn' => 'ذخیره به‌عنوان پیش‌نویس',
                'save-post-btn' => 'ذخیره و ثبت',
                'general' => 'عمومی',
                'entry-date' => 'تاریخ سند',
                'description' => 'توضیحات',
                'lines' => 'ردیف‌ها',
                'account' => 'حساب',
                'line-description' => 'توضیحات',
                'debit' => 'بدهکار',
                'credit' => 'بستانکار',
                'select-account' => 'انتخاب حساب',
                'add-line' => 'افزودن ردیف',
            ],
            'view' => [
                'back-btn' => 'بازگشت',
                'post-btn' => 'ثبت',
            ...
            'auto-post' => [
                'invoice' => 'به‌طور خودکار برای فاکتور :invoice ثبت شد',
                'payment' => 'پرداخت به‌طور خودکار برای فاکتور :invoice ثبت شد',
                'refund' => 'به‌طور خودکار برای بازپرداخت #:refund ثبت شد',
            ],
            'errors' => [
                'unbalanced-entry' => 'سند حسابداری موازنه ندارد. مجموع بدهکار باید با مجموع بستانکار برابر باشد.',
                'only-draft-can-be-posted' => 'فقط اسناد پیش‌نویس قابل ثبت هستند.',
                'only-posted-can-be-voided' => 'فقط اسناد ثبت‌شده قابل ابطال هستند.',
            ],
            'create-success' => 'سند حسابداری با موفقیت ایجاد شد.',
            'post-success' => 'سند حسابداری با موفقیت ثبت شد.',
            'void-success' => 'سند حسابداری با موفقیت باطل شد.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'دفتر کل',
                ...
                'credit' => 'بستانکار',
                'balance' => 'مانده',
                'no-transactions' => 'هیچ تراکنشی برای دوره انتخاب‌شده یافت نشد.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'سال‌های مالی',
                'create-btn' => 'ایجاد سال مالی',
                'datagrid' => [
                    'id' => 'شناسه',
                    'code' => 'کد',
                    'start-date' => 'تاریخ شروع',
            ...
            'create' => [
                ...
                'back-btn' => 'بازگشت',
                'save-btn' => 'ذخیره سال مالی',
                'code' => 'کد',
                'code-placeholder' => 'مثال: FY2026',
                'start-date' => 'تاریخ شروع',
                'end-date' => 'تاریخ پایان',
            ],
            'statuses' => [
            ...
            'create-success' => 'سال مالی با موفقیت ایجاد شد.',
            'close-success' => 'سال مالی با موفقیت بسته شد.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'تنظیمات حسابداری',
                'save-btn' => 'ذخیره تنظیمات',
                'mapping-title' => 'نگاشت پیش‌فرض حساب‌ها',
                'mapping-info' => 'حساب‌های مورد استفاده برای ثبت خودکار اسناد هنگام ایجاد فاکتور، پرداخت و بازپرداخت را مشخص کنید.',
                'accounts-receivable-account' => 'حساب دریافتنی',
                'cash-bank-account' => 'حساب نقدی / بانکی',
                'sales-revenue-account' => 'حساب درآمد فروش',
                'shipping-revenue-account' => 'حساب درآمد حمل‌ونقل',
                'sales-discount-account' => 'حساب تخفیف فروش',
                'sales-refund-account' => 'حساب بازپرداخت فروش',
                'tax-payable-account' => 'حساب مالیات پرداختنی',
                'not-mapped' => 'تعیین‌نشده',
            ],
            'update-success' => 'تنظیمات حسابداری با موفقیت به‌روزرسانی شد.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'تراز آزمایشی',
            ...
            'income-statement' => [
                ...
                'revenue' => 'درآمد',
                'expenses' => 'هزینه‌ها',
                'total-revenue' => 'جمع درآمد',
                'total-expense' => 'جمع هزینه‌ها',
                'net-income' => 'سود خالص',
            ],
            'balance-sheet' => [
                'title' => 'ترازنامه',
                ...
                'total-liabilities' => 'جمع بدهی‌ها',
                'total-equity' => 'جمع حقوق صاحبان سهام',
                'current-earnings' => 'سود دوره جاری',
                'total-liabilities-and-equity' => 'جمع بدهی‌ها و حقوق صاحبان سهام',
            ],
        ],
    ],
    ...
    'acl' => [
        ...
        'accounting-close' => 'بستن',
        'accounting-fiscal-years' => 'سال‌های مالی',
        'accounting-journal-entries' => 'اسناد حسابداری',
        'accounting-ledger' => 'دفتر کل',
        'accounting-post' => 'ثبت',
        'accounting-reports' => 'گزارش‌ها',
        'accounting-settings' => 'تنظیمات',
        'accounting-void' => 'ابطال',
        'addresses' => 'آدرس‌ها',
        'attribute-families' => 'خانواده‌های ویژگی',
        'attributes' => 'ویژگی‌ها',
        'campaigns' => 'کمپین‌ها',
