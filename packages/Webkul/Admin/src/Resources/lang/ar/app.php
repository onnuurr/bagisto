...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create-success' => 'تم إنشاء الحساب بنجاح.',
            'update-success' => 'تم تحديث الحساب بنجاح.',
            'delete-success' => 'تم حذف الحساب بنجاح.',
            'system-account-error' => 'هذا حساب نظام محمي ولا يمكن حذفه.',
            'in-use-error' => 'يحتوي هذا الحساب على حسابات فرعية أو قيود يومية ولا يمكن حذفه.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'قيود اليومية',
                'create-btn' => 'إنشاء قيد يومية',
                'datagrid' => [
                    'id' => 'المعرف',
                    'entry-number' => 'رقم القيد',
                    'entry-date' => 'تاريخ القيد',
                    'reference-type' => 'المرجع',
                    'description' => 'الوصف',
                    'total' => 'الإجمالي',
                    'status' => 'الحالة',
                    'view' => 'عرض',
            ...
            'create' => [
                ...
                'back-btn' => 'رجوع',
                'save-draft-btn' => 'حفظ كمسودة',
                'save-post-btn' => 'حفظ وترحيل',
                'general' => 'عام',
                'entry-date' => 'تاريخ القيد',
                'description' => 'الوصف',
                'lines' => 'السطور',
            ...
            'auto-post' => [
                'invoice' => 'تم الترحيل تلقائيًا للفاتورة :invoice',
                'payment' => 'تم ترحيل الدفعة تلقائيًا للفاتورة :invoice',
                'refund' => 'تم الترحيل تلقائيًا لاسترداد المبلغ #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'قيد اليومية غير متوازن. يجب أن يساوي إجمالي المدين إجمالي الدائن.',
                'only-draft-can-be-posted' => 'يمكن ترحيل قيود اليومية في حالة المسودة فقط.',
                'only-posted-can-be-voided' => 'يمكن إلغاء قيود اليومية المرحّلة فقط.',
            ],
            'create-success' => 'تم إنشاء قيد اليومية بنجاح.',
            'post-success' => 'تم ترحيل قيد اليومية بنجاح.',
            'void-success' => 'تم إلغاء قيد اليومية بنجاح.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'دفتر الأستاذ',
                ...
                'credit' => 'دائن',
                'balance' => 'الرصيد',
                'no-transactions' => 'لم يتم العثور على معاملات للفترة المحددة.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'السنوات المالية',
                'create-btn' => 'إنشاء سنة مالية',
                'datagrid' => [
                    'id' => 'المعرف',
                    'code' => 'الرمز',
                    'start-date' => 'تاريخ البدء',
            ...
            'create-success' => 'تم إنشاء السنة المالية بنجاح.',
            'close-success' => 'تم إغلاق السنة المالية بنجاح.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'إعدادات المحاسبة',
                'save-btn' => 'حفظ الإعدادات',
                'mapping-title' => 'تعيين الحسابات الافتراضي',
                'mapping-info' => 'قم بتعيين الحسابات المستخدمة لترحيل قيود اليومية تلقائيًا عند إنشاء الفواتير والمدفوعات والمبالغ المستردة.',
                'accounts-receivable-account' => 'حساب الذمم المدينة',
                'cash-bank-account' => 'حساب النقدية / البنك',
                'sales-revenue-account' => 'حساب إيرادات المبيعات',
                'shipping-revenue-account' => 'حساب إيرادات الشحن',
                'sales-discount-account' => 'حساب خصومات المبيعات',
                'sales-refund-account' => 'حساب مرتجعات المبيعات',
                'tax-payable-account' => 'حساب الضرائب المستحقة',
                'not-mapped' => 'غير معيّن',
            ],
            'update-success' => 'تم تحديث إعدادات المحاسبة بنجاح.',
        ],
        'reports' => [
            'trial-balance' => [
                'title' => 'ميزان المراجعة',
                'as-of-date' => 'اعتبارًا من تاريخ',
                'filter-btn' => 'تصفية',
                'code' => 'الرمز',
                'account' => 'حساب',
                'debit' => 'مدين',
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => 'أرباح الفترة الحالية',
