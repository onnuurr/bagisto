            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    ...
                    'aras-kargo' => [
                        ...
                        'status' => 'الحالة',
                        'title' => 'العنوان',
                        'title-info' => 'يحسب أسعار الشحن باستخدام واجهة برمجة تطبيقات أراس كارجو ببيانات اعتماد حسابك، ويعتمد على سعر ثابت احتياطي في حال تعذر الوصول إلى الواجهة.',
                        'username' => 'اسم المستخدم',
                        'wsdl-url' => 'رابط WSDL',
                        'rate' => 'السعر',
                    ],
                    ...
                    'kargonomi' => [
                        ...
                        'shipping-provider-id' => 'معرف شركة الشحن المفضلة',
                        'status' => 'الحالة',
                        'title' => 'العنوان',
                        'title-info' => 'يحسب سعر شحن مباشر من خلال مقارنة أسعار شركات الشحن المتعددة في Kargonomi عن طريق إنشاء شحنة مسودة للسلة وقراءة عرض السعر الخاص بها، ويعتمد على سعر ثابت احتياطي إذا تعذر الوصول إلى الواجهة.',
