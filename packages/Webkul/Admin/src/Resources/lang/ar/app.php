...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'code-sent' => 'تم إرسال رمز تحقق جديد.',
    ...
    'account' => [
        'edit' => [
            ...
            'method-authenticator' => 'تطبيق المصادقة',
            'method-sms' => 'الرسائل النصية',
            'phone' => 'رقم الهاتف',
            'send-code' => 'إرسال الرمز',
            'two-factor-method' => 'طريقة التحقق بخطوتين',
        ],
        ...
        'messages' => [
            ...
            'code-sent-success' => 'تم إرسال رمز التحقق بنجاح.',
            'phone-required' => 'يرجى إضافة رقم هاتف قبل تفعيل التحقق عبر الرسائل النصية.',
        ],
    ...
    'catalog' => [
        ...
        'product-tags' => [
            'index' => [
                'add-btn' => 'إنشاء علامة منتج',
                'title' => 'علامات المنتج',

                'datagrid' => [
                    'delete' => 'حذف',
                    'delete-failed' => 'حدث خطأ أثناء حذف علامة المنتج',
                    'delete-success' => 'تم حذف علامة المنتج بنجاح.',
                    'edit' => 'تعديل',
                    'id' => 'الرقم المعرف',
                    'image' => 'صورة',
                    'mass-delete-success' => 'تم حذف علامات المنتج المحددة بنجاح',
                    'name' => 'الاسم',
                ],
            ],
            ...
            'create' => [
                ...
                'general' => 'عام',
                'image' => 'صورة',
                'image-info' => 'ستظهر الصورة على المنتج إذا كانت متوفرة، وإلا سيظهر الاسم كشارة نصية.',
                'name' => 'الاسم',
                'save-btn' => 'حفظ علامة المنتج',
                'title' => 'إضافة علامة منتج جديدة',
            ],
    ...
    'marketing' => [
        ...
        'promotions' => [
            'index' => [
                ...
                'gift-card-title' => 'بطاقات الهدايا',
            ],
            ...
            'gift-cards' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'expires-at' => 'تنتهي في',
                        'id' => 'المعرف',
                        'mass-delete-success' => 'تم حذف بطاقات الهدايا المحددة بنجاح',
                        'status' => 'الحالة',
                        'unused' => 'غير مستخدمة',
                        'used' => 'مستخدمة',
                ...
                'create' => [
                    'amount' => 'المبلغ',
                    'code' => 'الرمز',
                    'code-info' => 'اتركه فارغًا للإنشاء التلقائي.',
                    'currency' => 'العملة',
                    'customer-email' => 'البريد الإلكتروني للعميل',
                    'expires-at' => 'تنتهي في',
                    'quantity' => 'الكمية',
                    'quantity-info' => 'عدد بطاقات الهدايا المراد إنشاؤها. يتم تجاهل الرمز وإنشاؤه تلقائيًا عندما تكون الكمية أكبر من 1.',
                    'save-btn' => 'حفظ بطاقة الهدية',
                    'success' => 'تم إنشاء بطاقة الهدية بنجاح',
                    'title' => 'إنشاء بطاقة هدية',
                ],
                ...
                'edit' => [
                    ...
                    'expires-at' => 'تنتهي في',
                    'status' => 'الحالة',
                    'success' => 'تم تحديث بطاقة الهدية بنجاح',
                    'title' => 'تعديل بطاقة الهدية',
                    'unused' => 'غير مستخدمة',
                    'used' => 'مستخدمة',
                ],

                'delete-failed' => 'لا يمكن حذف بطاقة الهدية لأنها تم استردادها بالفعل',
                'delete-success' => 'تم حذف بطاقة الهدية بنجاح',
            ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'قم بتكوين إعدادات بوابة الدفع iyzico. بعد الحفظ، اضبط رابط الاستدعاء في إعدادات تكامل لوحة تحكم iyzico الخاصة بك على your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'أدخل المفتاح السري الخاص بك من لوحة تحكم iyzico',
                    'local-payment' => 'الدفع المحلي',
                    'local-payment-info' => 'طريقة دفع يدوية محلية يمكن تخصيصها حسب الحاجة.',
                    'logo' => 'الشعار',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'قم بتكوين إعدادات بوابة الدفع PayTR. بعد الحفظ، اضبط رابط الإشعار في لوحة تاجر PayTR الخاصة بك على your-shop-url/paytr/notify - يتطلب PayTR ضبط هذا يدويًا.',
                    'paytr-merchant-id-info' => 'أدخل رقم التاجر الخاص بك من لوحة PayTR',
                    'paytr-merchant-key-info' => 'أدخل مفتاح التاجر الخاص بك من لوحة PayTR',
                    'paytr-merchant-salt-info' => 'أدخل سولت التاجر الخاص بك من لوحة PayTR',
                    'payu' => 'باي يو',
            ...
            'sms' => [
                'info' => 'قم بتهيئة بوابات الرسائل النصية وإشعارات الطلبات والتحقق بخطوتين عبر الرسائل النصية.',
                'title' => 'الرسائل النصية',

                'general' => [
                    'info' => 'إعدادات عامة للرسائل النصية.',
                    'title' => 'عام',

                    'settings' => [
                        'active-gateway' => 'البوابة النشطة',
                        'enabled' => 'مفعّل',
                        'title' => 'الإعدادات',
                        'title-info' => 'قم بتفعيل أو تعطيل إشعارات الرسائل النصية عبر تطبيقك بالكامل.',
                    ],
                ],

                'gateways' => [
                    'credential-id' => 'معرّف الحساب (SID) / مفتاح API',
                    'credential-secret' => 'رمز المصادقة (Auth Token) / سر API',
                    'info' => 'قم بتهيئة بيانات اعتماد مزود بوابة الرسائل النصية الخاص بك.',
                    'sender' => 'رقم المرسل / معرّف المرسل',
                    'title' => 'البوابات',

                    'twilio' => [
                        'title' => 'Twilio',
                        'title-info' => 'قم بتهيئة بيانات اعتماد Twilio API.',
                    ],

                    'vonage' => [
                        'title' => 'Vonage',
                        'title-info' => 'قم بتهيئة بيانات اعتماد Vonage (Nexmo) API.',
                    ],
                ...
                'notifications' => [
                    'enabled-label' => 'مفعّل',
                    'info' => 'قم بتفعيل إشعارات الرسائل النصية لأحداث الطلبات وتخصيص قوالب الرسائل الخاصة بها.',
                    'template-label' => 'قالب الرسالة',
                    'title' => 'إشعارات الطلبات',

                    'order-placed' => [
                        'title' => 'تم تقديم الطلب',
                        'title-info' => 'إشعار العميل عبر رسالة نصية عند تقديم الطلب.',
                    ],

                    'order-shipped' => [
                        'title' => 'تم شحن الطلب',
                        'title-info' => 'إشعار العميل عبر رسالة نصية عند شحن طلبه.',
                    ],

                    'order-cancelled' => [
                        'title' => 'تم إلغاء الطلب',
                        'title-info' => 'إشعار العميل عبر رسالة نصية عند إلغاء طلبه.',
                    ],

                    'invoice-created' => [
                        'title' => 'تم إنشاء الفاتورة',
                        'title-info' => 'إشعار العميل عبر رسالة نصية عند إنشاء فاتورة لطلبه.',
                    ],

                    'refund-created' => [
                        'title' => 'تم إنشاء الاسترداد',
                        'title-info' => 'إشعار العميل عبر رسالة نصية عند إنشاء استرداد لطلبه.',
                    ],
                ],

                'two-factor' => [
                    'info' => 'السماح للمسؤولين باستخدام الرسائل النصية كطريقة للتحقق بخطوتين.',
                    ...
                    'settings' => [
                        ...
                        'title' => 'الإعدادات',
                        'sms' => 'الرسائل النصية',
                        'title-info' => 'تفعيل الرسائل النصية كطريقة متاحة للتحقق بخطوتين لحسابات المسؤولين.',
                    ],
                ],
            ],
        ],
    ...
    'sms' => [
        ...
        'notifications' => [
            'order-placed' => [
                'default-template' => 'مرحبًا {customer_name}، تم تقديم طلبك رقم #{order_id} بنجاح. الإجمالي: {order_total}. شكرًا لتسوقك معنا!',
            ],

            'order-shipped' => [
                'default-template' => 'مرحبًا {customer_name}، تم شحن طلبك رقم #{order_id} وهو في الطريق إليك.',
            ],

            'order-cancelled' => [
                'default-template' => 'مرحبًا {customer_name}، تم إلغاء طلبك رقم #{order_id}.',
            ],

            'invoice-created' => [
                'default-template' => 'مرحبًا {customer_name}، تم إنشاء فاتورة لطلبك رقم #{order_id}. الإجمالي: {order_total}.',
            ],

            'refund-created' => [
                'default-template' => 'مرحبًا {customer_name}، تم معالجة استرداد لطلبك رقم #{order_id}.',
            ],
        ],

        'two-factor' => [
            'otp-message' => 'رمز التحقق الخاص بك هو :code. سينتهي خلال 5 دقائق.',
        ],

        'messages' => [
            'delete-success' => 'تم حذف سجل الرسائل النصية بنجاح.',
        ],
    ],
];
