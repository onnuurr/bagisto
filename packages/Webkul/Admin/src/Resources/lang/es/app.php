...
return [
    ...
    'accounting' => [
        'accounts' => [
            ...
            'create' => [
                ...
                'type' => 'Tipo',
                'parent' => 'Cuenta principal',
                'no-parent' => 'Sin cuenta principal',
                'opening-balance' => 'Saldo inicial',
                'status' => 'Estado',
                'description' => 'Descripción',
            ],
            ...
            'create-success' => 'Cuenta creada correctamente.',
            'update-success' => 'Cuenta actualizada correctamente.',
            'delete-success' => 'Cuenta eliminada correctamente.',
            'system-account-error' => 'Esta es una cuenta de sistema protegida y no se puede eliminar.',
            'in-use-error' => 'Esta cuenta tiene subcuentas o asientos contables y no se puede eliminar.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Asientos contables',
                'create-btn' => 'Crear asiento contable',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Número de asiento',
                    'entry-date' => 'Fecha del asiento',
                    'reference-type' => 'Referencia',
                    'description' => 'Descripción',
                    'total' => 'Total',
                    'status' => 'Estado',
                    'view' => 'Ver',
            ...
            'create' => [
                ...
                'back-btn' => 'Volver',
                'save-draft-btn' => 'Guardar como borrador',
                'save-post-btn' => 'Guardar y contabilizar',
                'general' => 'General',
                'entry-date' => 'Fecha del asiento',
                'description' => 'Descripción',
                'lines' => 'Líneas',
            ...
            'auto-post' => [
                'invoice' => 'Contabilizado automáticamente para la factura :invoice',
                'payment' => 'Pago contabilizado automáticamente para la factura :invoice',
                'refund' => 'Contabilizado automáticamente para el reembolso #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'El asiento no está balanceado. El total del debe debe ser igual al total del haber.',
                'only-draft-can-be-posted' => 'Solo los asientos en borrador se pueden contabilizar.',
                'only-posted-can-be-voided' => 'Solo los asientos contabilizados se pueden anular.',
            ],
            'create-success' => 'Asiento contable creado correctamente.',
            'post-success' => 'Asiento contable contabilizado correctamente.',
            'void-success' => 'Asiento contable anulado correctamente.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Libro mayor',
                ...
                'credit' => 'Haber',
                'balance' => 'Saldo',
                'no-transactions' => 'No se encontraron transacciones para el período seleccionado.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Años fiscales',
                'create-btn' => 'Crear año fiscal',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Código',
                    'start-date' => 'Fecha de inicio',
            ...
            'create' => [
                ...
                'back-btn' => 'Volver',
                'save-btn' => 'Guardar año fiscal',
                'code' => 'Código',
                'code-placeholder' => 'ej. AF2026',
                'start-date' => 'Fecha de inicio',
                'end-date' => 'Fecha de fin',
            ],
            'statuses' => [
            ...
            'create-success' => 'Año fiscal creado correctamente.',
            'close-success' => 'Año fiscal cerrado correctamente.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Configuración de contabilidad',
                'save-btn' => 'Guardar configuración',
                'mapping-title' => 'Asignación de cuentas predeterminada',
                'mapping-info' => 'Asigne las cuentas utilizadas para contabilizar automáticamente los asientos al crear facturas, pagos y reembolsos.',
                'accounts-receivable-account' => 'Cuenta por cobrar',
                'cash-bank-account' => 'Cuenta de caja / banco',
                'sales-revenue-account' => 'Cuenta de ingresos por ventas',
                'shipping-revenue-account' => 'Cuenta de ingresos por envío',
                'sales-discount-account' => 'Cuenta de descuentos en ventas',
                'sales-refund-account' => 'Cuenta de reembolsos de ventas',
                'tax-payable-account' => 'Cuenta de impuestos por pagar',
                'not-mapped' => 'Sin asignar',
            ],
            'update-success' => 'Configuración de contabilidad actualizada correctamente.',
        ],
        'reports' => [
            'trial-balance' => [
            ...
            'balance-sheet' => [
                ...
                'total-equity' => 'Total de patrimonio',
                'current-earnings' => 'Resultado del periodo',
                'total-liabilities-and-equity' => 'Total pasivo y patrimonio',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Configure los ajustes de la pasarela de pago iyzico. Después de guardar, establezca la URL de retorno en la configuración de integración de su panel de iyzico como your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Introduzca su clave secreta obtenida del panel de iyzico',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Configure los ajustes de la pasarela de pago PayTR. Después de guardar, establezca la URL de notificación en su panel de comerciante de PayTR como your-shop-url/paytr/notify — PayTR requiere que esto se configure manualmente.',
                    'paytr-merchant-id-info' => 'Introduzca su ID de comercio obtenido del panel de PayTR',
                    'paytr-merchant-key-info' => 'Introduzca su clave de comercio obtenida del panel de PayTR',
                    'paytr-merchant-salt-info' => 'Introduzca su sal de comercio obtenida del panel de PayTR',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Configuración',
    ...
    'acl' => [
        ...
        'accounting-close' => 'Cerrar',
        'accounting-fiscal-years' => 'Años fiscales',
