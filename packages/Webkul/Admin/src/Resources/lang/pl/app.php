...
return [
    ...
    'accounting' => [
        'accounts' => [
            'index' => [
                'title' => 'Plan kont',
                'create-btn' => 'Utwórz konto',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Kod',
                    'name' => 'Nazwa',
                    'parent' => 'Konto nadrzędne',
                    'type' => 'Typ',
            ...
            'create' => [
                ...
                'type' => 'Typ',
                'parent' => 'Konto nadrzędne',
                'no-parent' => 'Brak konta nadrzędnego',
                'opening-balance' => 'Saldo początkowe',
                'status' => 'Status',
                'description' => 'Opis',
            ],
            ...
            'create-success' => 'Konto zostało utworzone pomyślnie.',
            'update-success' => 'Konto zostało zaktualizowane pomyślnie.',
            'delete-success' => 'Konto zostało usunięte pomyślnie.',
            'system-account-error' => 'To jest chronione konto systemowe i nie może zostać usunięte.',
            'in-use-error' => 'To konto ma konta podrzędne lub zapisy księgowe i nie może zostać usunięte.',
        ],
        'journal-entries' => [
            'index' => [
                'title' => 'Zapisy księgowe',
                'create-btn' => 'Utwórz zapis księgowy',
                'datagrid' => [
                    'id' => 'ID',
                    'entry-number' => 'Numer zapisu',
                    'entry-date' => 'Data zapisu',
                    'reference-type' => 'Odniesienie',
                    'description' => 'Opis',
                    'total' => 'Razem',
                    'status' => 'Status',
                    'view' => 'Podgląd',
            ...
            'create' => [
                'title' => 'Utwórz zapis księgowy',
                'back-btn' => 'Wstecz',
                'save-draft-btn' => 'Zapisz jako szkic',
                'save-post-btn' => 'Zapisz i zaksięguj',
                'general' => 'Ogólne',
                'entry-date' => 'Data zapisu',
                'description' => 'Opis',
                'lines' => 'Pozycje',
                'account' => 'Konto',
                'line-description' => 'Opis',
                'debit' => 'Winien',
                'credit' => 'Ma',
            ...
            'auto-post' => [
                'invoice' => 'Automatycznie zaksięgowano dla faktury :invoice',
                'payment' => 'Automatycznie zaksięgowano płatność dla faktury :invoice',
                'refund' => 'Automatycznie zaksięgowano dla zwrotu #:refund',
            ],
            'errors' => [
                'unbalanced-entry' => 'Zapis księgowy nie jest zbilansowany. Suma Winien musi być równa sumie Ma.',
                'only-draft-can-be-posted' => 'Można księgować tylko zapisy w wersji roboczej.',
                'only-posted-can-be-voided' => 'Można anulować tylko zaksięgowane zapisy.',
            ],
            'create-success' => 'Zapis księgowy został utworzony pomyślnie.',
            'post-success' => 'Zapis księgowy został zaksięgowany pomyślnie.',
            'void-success' => 'Zapis księgowy został anulowany pomyślnie.',
        ],
        'ledger' => [
            'index' => [
                'title' => 'Księga główna',
                ...
                'credit' => 'Ma',
                'balance' => 'Saldo',
                'no-transactions' => 'Nie znaleziono transakcji dla wybranego okresu.',
            ],
        ],
        'fiscal-years' => [
            'index' => [
                'title' => 'Lata obrotowe',
                'create-btn' => 'Utwórz rok obrotowy',
                'datagrid' => [
                    'id' => 'ID',
                    'code' => 'Kod',
                    'start-date' => 'Data rozpoczęcia',
            ...
            'create' => [
                'title' => 'Utwórz rok obrotowy',
                'back-btn' => 'Wstecz',
                'save-btn' => 'Zapisz rok obrotowy',
                'code' => 'Kod',
                'code-placeholder' => 'np. RO2026',
                'start-date' => 'Data rozpoczęcia',
                'end-date' => 'Data zakończenia',
            ],
            'statuses' => [
            ...
            'create-success' => 'Rok obrotowy został utworzony pomyślnie.',
            'close-success' => 'Rok obrotowy został zamknięty pomyślnie.',
        ],
        'settings' => [
            'edit' => [
                'title' => 'Ustawienia księgowości',
                'save-btn' => 'Zapisz ustawienia',
                'mapping-title' => 'Domyślne mapowanie kont',
                'mapping-info' => 'Przypisz konta używane do automatycznego księgowania zapisów przy tworzeniu faktur, płatności i zwrotów.',
                'accounts-receivable-account' => 'Konto należności',
                'cash-bank-account' => 'Konto kasa / bank',
                'sales-revenue-account' => 'Konto przychodów ze sprzedaży',
                'shipping-revenue-account' => 'Konto przychodów z wysyłki',
                'sales-discount-account' => 'Konto rabatów sprzedaży',
                'sales-refund-account' => 'Konto zwrotów sprzedaży',
                'tax-payable-account' => 'Konto podatku do zapłaty',
                'not-mapped' => 'Nieprzypisane',
            ],
            'update-success' => 'Ustawienia księgowości zostały zaktualizowane pomyślnie.',
        ],
        'reports' => [
            'trial-balance' => [
            ...
            'balance-sheet' => [
                ...
                'current-earnings' => 'Wynik bieżącego okresu',
                'total-liabilities-and-equity' => 'Zobowiązania i kapitał własny razem',
            ],
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'iyzico' => 'iyzico',
                    'iyzico-info' => 'Skonfiguruj ustawienia bramki płatności iyzico. Po zapisaniu ustaw adres URL wywołania zwrotnego w ustawieniach integracji panelu iyzico na your-shop-url/iyzico/callback.',
                    'iyzico-secret-key-info' => 'Wprowadź swój klucz tajny uzyskany z panelu iyzico',
                    ...
                    'paytr' => 'PayTR',
                    'paytr-info' => 'Skonfiguruj ustawienia bramki płatności PayTR. Po zapisaniu ustaw adres URL powiadomień w panelu sprzedawcy PayTR na your-shop-url/paytr/notify — PayTR wymaga ręcznego ustawienia tego adresu.',
                    'paytr-merchant-id-info' => 'Wprowadź swój identyfikator sprzedawcy uzyskany z panelu PayTR',
                    'paytr-merchant-key-info' => 'Wprowadź swój klucz sprzedawcy uzyskany z panelu PayTR',
                    'paytr-merchant-salt-info' => 'Wprowadź swoją sól sprzedawcy uzyskaną z panelu PayTR',
                    'payu' => 'PayU',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'accounting-settings' => 'Ustawienia',
                'chart-of-accounts' => 'Plan kont',
                'fiscal-years' => 'Lata obrotowe',
    ...
    'acl' => [
        'accounting' => 'Księgowość',
        'accounting-accounts' => 'Plan kont',
        'accounting-close' => 'Zamknij',
        'accounting-fiscal-years' => 'Lata obrotowe',
        'accounting-journal-entries' => 'Zapisy księgowe',
        'accounting-ledger' => 'Księga główna',
        'accounting-post' => 'Zaksięguj',
        'accounting-reports' => 'Raporty',
        'accounting-settings' => 'Ustawienia',
        'accounting-void' => 'Anuluj',
        'addresses' => 'Adresy',
        'attribute-families' => 'Rodziny Atrybutów',
        'attributes' => 'Atrybuty',
        'campaigns' => 'Kampanie',
