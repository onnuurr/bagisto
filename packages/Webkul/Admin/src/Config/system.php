...
return [
    ...
    [
        ...
        'key' => 'sales.carriers.araskargo',
        'name' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.page-title',
        'info' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.title-info',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'title',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.title',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'description',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.description',
                'type' => 'textarea',
                'channel_based' => true,
                'locale_based' => true,
            ], [
                'name' => 'username',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.username',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'password',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.password',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'customer_code',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.customer-code',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'active',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.aras-kargo.status',
                'type' => 'boolean',
                'channel_based' => true,
                'locale_based' => false,
            ],
        ...
        'key' => 'sales.carriers.kargonomi',
        'name' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.page-title',
        'info' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.title-info',
        'sort' => 4,
        'fields' => [
            [
                'name' => 'title',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.title',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'description',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.description',
                'type' => 'textarea',
                'channel_based' => true,
                'locale_based' => true,
            ], [
                'name' => 'api_token',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.api-token',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'app_key',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.app-key',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'warehouse_id',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.warehouse-id',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.shipping-provider-id',
                'type' => 'text',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'default_rate',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.rate',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1|numeric',
                'channel_based' => true,
                ...
                'name' => 'active',
                'title' => 'admin::app.configuration.index.sales.shipping-methods.kargonomi.status',
                'type' => 'boolean',
                'channel_based' => true,
                'locale_based' => false,
            ],
        ...
        'name' => 'admin::app.configuration.index.sales.payment-methods.paytr',
        'info' => 'admin::app.configuration.index.sales.payment-methods.paytr-info',
        'sort' => 11,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'merchant_id',
                'title' => 'admin::app.configuration.index.sales.payment-methods.merchant-id',
                'info' => 'admin::app.configuration.index.sales.payment-methods.paytr-merchant-id-info',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'merchant_key',
                'title' => 'admin::app.configuration.index.sales.payment-methods.merchant-key',
                'info' => 'admin::app.configuration.index.sales.payment-methods.paytr-merchant-key-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
                ...
                'name' => 'merchant_salt',
                'title' => 'admin::app.configuration.index.sales.payment-methods.merchant-salt',
                'info' => 'admin::app.configuration.index.sales.payment-methods.paytr-merchant-salt-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
        ...
        'name' => 'admin::app.configuration.index.sales.payment-methods.iyzico',
        'info' => 'admin::app.configuration.index.sales.payment-methods.iyzico-info',
        'sort' => 12,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'api_key',
                'title' => 'admin::app.configuration.index.sales.payment-methods.api-key',
                'info' => 'admin::app.configuration.index.sales.payment-methods.iyzico-secret-key-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
