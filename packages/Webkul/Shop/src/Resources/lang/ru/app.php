    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'summary' => [
                ...
                'gift-card-amount' => 'Подарочная карта',
                'grand-total' => 'Общая сумма',
                'included' => 'Включено',
                'excl-tax' => 'Без налога:',
                'incl-tax' => 'С налогом:',
        ...
        'gift-card' => [
            'already-applied' => 'Код подарочной карты уже применен.',
            'applied' => 'Подарочная карта применена',
            'apply' => 'Применить подарочную карту',
            'button-title' => 'Применить',
            'enter-your-code' => 'Введите код',
            'invalid' => 'Неверный код подарочной карты.',
            'remove' => 'Удалить подарочную карту',
            'subtotal' => 'Итого',
            'success-apply' => 'Код подарочной карты успешно применен.',
