    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'summary' => [
                ...
                'gift-card-amount' => 'Подарункова картка',
                'grand-total' => 'Загальна сума',
                'included' => 'Включено',
                'excl-tax' => 'Без податку:',
                'incl-tax' => 'З податком:',
        ...
        'gift-card' => [
            'already-applied' => 'Код подарункової картки вже застосований.',
            'applied' => 'Подарункову картку застосовано',
            'apply' => 'Застосувати подарункову картку',
            'button-title' => 'Застосувати',
            'enter-your-code' => 'Введіть свій код',
            'invalid' => 'Код подарункової картки недійсний.',
            'remove' => 'Видалити подарункову картку',
            'subtotal' => 'Підсумок',
            'success-apply' => 'Код подарункової картки успішно застосовано.',
