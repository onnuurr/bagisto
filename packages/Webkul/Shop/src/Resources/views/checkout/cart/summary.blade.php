<div class="w-[418px] max-w-full max-md:w-full">
    ...
    <div class="mt-6 grid gap-4 max-md:mt-2 max-md:gap-2.5">
        ...
        <!-- Apply Gift Card -->
        {!! view_render_event('bagisto.shop.checkout.cart.summary.gift_card.before') !!}
        ...
        <template v-if="cart.gift_cards_amount && parseFloat(cart.gift_cards_amount) > 0">
            <div class="flex justify-between text-right">
                <p class="text-base text-red-600 max-sm:text-sm">
                    @lang('shop::app.checkout.cart.summary.gift-card-amount')
                </p>
        ...
        {!! view_render_event('bagisto.shop.checkout.cart.summary.gift_card.after') !!}
