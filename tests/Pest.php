...
use Webkul\Iyzico\Tests\IyzicoTestCase;
use Webkul\Payment\Tests\PaymentTestCase;
use Webkul\PayTR\Tests\PayTRTestCase;
...
uses(IyzicoTestCase::class)->in('../packages/Webkul/Iyzico/tests');
uses(PaymentTestCase::class)->in('../packages/Webkul/Payment/tests');
uses(PayTRTestCase::class)->in('../packages/Webkul/PayTR/tests');
